//This file includes all Sencha-touch defined functions, objects in the framework.
	...
	b
			.implement({
				...
				callSuper : function(e) {
					var f, d = (f = this.callSuper.caller)
							&& ((f = f.$owner ? f : f.caller) && f.$owner.superclass[f.$name]);
					return d.apply(this, e || c)
				},
					...
					doFire : function() {
						...
						for (d = 0, f = k.length; d < f; d++) {
							...
							if (!n) {
								n = a;
								if (o.buffer) {
									n = Ext.Function.createBuffered(n,
											o.buffer, l)
								}
								if (o.delay) {
									n = Ext.Function.createDelayed(n, o.delay,
											l)
								}
								b.firingFn = n
							}
				...
				"Ext.mixin.Observable",
				{
					...
					getEventDispatcher : function() {
						if (!this.eventDispatcher) {
							this.eventDispatcher = Ext.event.Dispatcher
									.getInstance();
					...
					getManagedListeners : function(c, b) {
						...
						if (!a[d]) {
							a[d] = {};
							c.doAddListener("destroy", "clearManagedListeners",
									this, {
										single : true,
										args : [ c ]
									})
					...
					doFireEvent : function(b, c, e, a) {
						...
						var f = this.getObservableId(), d = this
								.getEventDispatcher();
						return d.dispatchEvent(this.observableType, f, b, c, e,
								a)
					},
					doAddListener : function(a, i, k, l, c) {
						var e = (k && k !== this && k.isIdentifiable), b = this
								.getUsedSelectors(), f = b.$map, d = this
								.getObservableId(), g, j, h;
						if (!l) {
							l = {}
						}
						if (!k) {
					...
					addDispatcherListener : function(b, d, f, e, c, a) {
						return this.getEventDispatcher().addListener(
								this.observableType, b, d, f, e, c, a)
					},
							...
							for (f in c) {
								if (c.hasOwnProperty(f)) {
									...
									for (e = 0, g = h.length; e < g; e++) {
										...
										if (this.doRemoveListener(f, b.fn,
												b.scope, k, b.order)) {
											e--;
											g--
										}
						...
						if (typeof n != "undefined") {
							...
							if (Ext.isArray(h)) {
								...
								for (f = 0, k = m.length; f < k; f++) {
									c = m[f];
									l.call(this, c.event, c.fn, c.scope, c,
											c.order)
								}
							} else {
					...
					addListener : function(b, e, d, c, a) {
						return this.changeListener(this.doAddListener, b, e, d,
								c, a)
					},
					toggleListener : function(b, c, f, e, d, a) {
						return this.changeListener(b ? this.doAddListener
								: this.doRemoveListener, c, f, e, d, a)
					},
					...
					removeListener : function(b, e, d, c, a) {
						return this.changeListener(this.doRemoveListener, b, e,
								d, c, a)
					},
					...
					clearListeners : function() {
						var e = this.getUsedSelectors(), c = this
								.getEventDispatcher(), b, d, a;
					...
					hasListener : function(a) {
						return this.getEventDispatcher().hasListener(
								this.observableType, this.getObservableId(), a)
					},
					...
					relayEvents : function(b, d, g) {
						...
						if (Ext.isArray(d)) {
							for (c = 0, f = d.length; c < f; c++) {
								e = d[c];
								a = g + e;
								b.addListener(e, this.createEventRelayer(a),
										this)
							}
						} else {
							for (e in d) {
								if (d.hasOwnProperty(e)) {
									a = g + d[e];
									b.addListener(e,
											this.createEventRelayer(a), this)
								}
							}
						}
						return this
					...
					createEventRelayer : function(a) {
						return function() {
							return this.doFireEvent(a, Array.prototype.slice
									.call(arguments, 0, -2))
						}
					},
					enableBubble : function(d) {
						...
						for (c = 0, e = d.length; c < e; c++) {
							...
							if (!a[b]) {
								a[b] = true;
								this.addListener(b, this.createEventBubbler(b),
										this)
							}
						}
					},
					createEventBubbler : function(a) {
						return function b() {
							var c = ("getBubbleTarget" in this) ? this
									.getBubbleTarget() : null;
							if (c && c !== this && c.isObservable) {
								c.fireAction(a, Array.prototype.slice.call(
										arguments, 0, -2), b, c, null, "after")
							}
						}
					},
				...
				"Ext.AbstractComponent",
				{
					...
					initElement : function() {
						...
						if (k.hasOwnProperty("renderTemplate")) {
							...
							v = Ext.Element.create(this.getElementConfig(),
									true);
							e.appendChild(v)
						}
	...
	Ext.DateExtras = {
		...
		add : function(f, e, g) {
			...
			case Ext.Date.MONTH:
				var c = f.getDate();
				if (c > 28) {
					c = Math.min(c, Ext.Date.getLastDateOfMonth(
							Ext.Date.add(Ext.Date.getFirstDateOfMonth(f), "mo",
									g)).getDate())
				}
				h.setDate(c);
		...
		align : function(d, f, e) {
			...
			case Ext.Date.MONTH:
				...
				break;
			case Ext.Date.YEAR:
				c.setUTCFullYear(c.getUTCFullYear() - c.getUTCFullYear() % e,
						1, 1);
				c.setUTCHours(0);
				c.setUTCMinutes(0);
				c.setUTCSeconds(0);
		...
		.define(
				"Ext.util.Format",
				{
					...
					ellipsis : function(c, a, d) {
						if (c && c.length > a) {
							if (d) {
								var e = c.substr(0, a - 2), b = Math.max(e
					...
					format : function(b) {
						...
						return b.replace(Ext.util.Format.formatRe, function(c,
								d) {
							return a[d]
						})
					},
					htmlEncode : function(a) {
						return !a ? a : String(a).replace(/&/g, "&amp;")
								.replace(/>/g, "&gt;").replace(/</g, "&lt;")
								.replace(/"/g, "&quot;")
					},
						...
						if (!Ext.isDate(b)) {
							...
							if (isNaN(a)) {
								if (this.iso8601TestRe.test(b)) {
									...
									a = new Date(a[0], a[1] - 1, a[2], a[3],
											a[4], a[5])
								}
								if (isNaN(a)) {
									a = new Date(Date.parse(b.replace(
											this.dashesRe, "/")))
								}
							}
							b = a
				...
				"Ext.Template",
				{
					...
					apply : function(a) {
						...
						function e(h, j, k, i) {
							if (k && d) {
								if (i) {
									i = [ a[j] ].concat(Ext.functionFactory(
											"return [" + i + "];")())
								} else {
									i = [ a[j] ]
								}
					...
					doInsert : function(b, d, a, e) {
						var c = Ext.DomHelper.insertHtml(b, Ext.getDom(d), this
								.apply(a));
						return e ? Ext.get(c) : c
					},
					overwrite : function(c, a, d) {
						var b = Ext.DomHelper.overwrite(Ext.getDom(c), this
								.apply(a));
		...
		.define(
				"Ext.XTemplateCompiler",
				{
					...
					compile : function(a) {
						...
						return c.useEval ? c.evalTpl(b) : (new Function("Ext",
								b))(Ext)
					},
					generate : function(a) {
						...
						d.switches = [];
						d.parse(a);
						d.definitions.push((d.useEval ? "$=" : "return")
								+ " function (" + d.fnArgs + ") {", d.body
								.join(""), "}");
					...
					doEnd : function(b, d) {
						...
						if (b == "for") {
							...
							c.body.push("}\n");
							c.body.push("parent=p", a, ";values=r", a + 1,
									";xcount=n", a, ";xindex=i", a, "\n")
						} else {
							if (b == "if" || b == "switch") {
								c.body.push("}\n")
							}
					...
					doFor : function(f, h) {
						...
						e.body.push("i", b, "=0,n", b, "=0,c", b, "=", d, ",a",
								b, "=", e.createArrayTest(b), ",p", b, "=c", a,
								",r", b, "=values;\n", "parent=", g, "\n",
								"if (c", b, "){if(a", b, "){n", b, "=c", b,
								".length;}else if (c", b,
								".isMixedCollection){c", b, "=c", b,
								".items;n", b, "=c", b, ".length;}else if(c",
								b, ".isStore){c", b, "=c", b, ".data.items;n",
								b, "=c", b, ".length;}else{c", b, "=[c", b,
								"];n", b, "=1;}}\n", "for (xcount=n", b, ";i",
								b, "<n" + b + ";++i", b, "){\n", "values=c", b,
								"[i", b, "]");
						if (h.propName) {
					...
					addFn : function(a) {
						...
						if (a === ".") {
							...
							if (a === "..") {
								c.definitions.push("function " + b + "("
										+ c.fnArgs + ") {", " return parent",
										"}")
							} else {
								c.definitions.push("function " + b + "("
										+ c.fnArgs + ") {",
										" try { with(values) {", "  return("
												+ a + ")", " }} catch(e) {",
										"}", "}")
							}
						}
		...
		.define(
				"Ext.util.translatable.Abstract",
				{
					...
					factoryEasing : function(a) {
						return Ext.factory(a, Ext.fx.easing.Linear, null,
								"easing")
					},
					...
					translateAnimated : function(b, g, e) {
						...
						var d = Ext.Date.now(), f = e.easing, c = (typeof b == "number") ? (e.easingX
								|| f || this.getEasingX() || true)
								: null, a = (typeof g == "number") ? (e.easingY
								|| f || this.getEasingY() || true) : null;
						if (c) {
					...
					doAnimationFrame : function() {
						var e = this, c = e.activeEasingX, b = e.activeEasingY, d = Date
								.now(), a, f;
						this.animationFrameId = requestAnimationFrame(this.doAnimationFrame);
						if (!e.isAnimating) {
							return
...
Ext.define("Ext.util.translatable.CssTransform", {
	...
	doTranslate : function() {
		this.getElement().dom.style.webkitTransform = "translate3d(" + this.x
				+ "px, " + this.y + "px, 0px)"
	},
	destroy : function() {
...
Ext.define("Ext.util.translatable.ScrollPosition", {
	...
	getWrapper : function() {
		...
		if (!c) {
			...
			this.wrapper = c;
			c.on("resize", "onWrapperResize", this);
			c.on("painted", "refresh", this);
			this.refresh()
		}
		return c
	},
	doTranslate : function(a, d) {
		...
		if (c) {
			...
			if (typeof d == "number") {
				b.scrollTop = this.wrapperHeight - d
			}
		}
	},
	onWrapperResize : function(b, a) {
		this.wrapperWidth = a.width;
		this.wrapperHeight = a.height;
		this.refresh()
	},
	destroy : function() {
		...
		if (b) {
			...
			b.un("resize", "onWrapperResize", this);
		...
		.define(
				"Ext.util.Draggable",
				{
					...
					onDragStart : function(a) {
						...
						var b = this.offset;
						this.fireAction("dragstart", [ this, a, b.x, b.y ],
								this.initDragStart)
					},
					...
					onDrag : function(b) {
						...
						this.fireAction("drag", [ this, b, a.x + b.deltaX,
								a.y + b.deltaY ], this.doDrag)
					},
					...
					onDragEnd : function(a) {
						...
						this.fireEvent("dragend", this, a, this.offset.x,
								this.offset.y)
					},
	...
	Ext
			.define(
					"Ext.Component",
					{
						...
						requires : [ "Ext.ComponentManager", "Ext.XTemplate",
								"Ext.dom.Element", "Ext.behavior.Translatable",
						...
						applyPlugins : function(b) {
							...
							for (c = 0, d = b.length; c < d; c++) {
								e = b[c];
								b[c] = Ext.factory(e, "Ext.plugin.Plugin",
										null, "plugin")
							}
							return b
						},
						...
						updateCls : function(c, b) {
							if (this.element
									&& ((c && !b) || (!c && b)
											|| c.length != b.length || Ext.Array
											.difference(c, b).length > 0)) {
						...
						doRefreshSizeState : function() {
							var c = this.getWidth() !== null
									|| this.widthLayoutSized
									|| (this.getLeft() !== null && this
											.getRight() !== null), d = this
									.getHeight() !== null
									|| this.heightLayoutSized
									|| (this.getTop() !== null && this
											.getBottom() !== null), f = this.layoutStretched
									|| (!d && this.getMinHeight() !== null), e = c
									&& d, b = (c && this.LAYOUT_WIDTH)
									| (d && this.LAYOUT_HEIGHT)
									| (f && this.LAYOUT_STRETCHED);
							if (!e && f) {
								e = null
							}
							this.setSizeState(e);
						...
						refreshInnerState : function() {
							this.setIsInner(!this.isCentered()
									&& !this.isFloating() && !this.isDocked())
						},
						...
						doSetDisabled : function(b) {
							this.element[b ? "addCls" : "removeCls"](this
									.getDisabledCls())
						},
						...
						getInnerHtmlElement : function() {
							var b = this.innerHtmlElement, c = this
									.getStyleHtmlCls();
							if (!b || !b.dom || !b.dom.parentNode) {
								this.innerHtmlElement = b = this.innerElement
										.createChild({
											cls : "x-innerhtml "
										});
						...
						doSetHidden : function(c) {
							...
							if (this.element) {
								this.element[c ? "addCls" : "removeCls"](this
										.getHiddenCls())
							}
						...
						applyTpl : function(b) {
							return (Ext.isObject(b) && b.isTemplate) ? b
									: new Ext.XTemplate(b)
						},
						...
						getDraggableBehavior : function() {
							...
							if (!b) {
								b = this.draggableBehavior = new Ext.behavior.Draggable(
										this)
							}
							return b
						},
						...
						getTranslatableBehavior : function() {
							...
							if (!b) {
								b = this.translatableBehavior = new Ext.behavior.Translatable(
										this)
							}
							return b
						},
						...
						getTranslatable : function() {
							return this.getTranslatableBehavior()
									.getTranslatable()
						},
						...
						doAddListener : function(d, f, e, c, b) {
							if (c && "element" in c) {
								return this[c.element].doAddListener(d, f, e
										|| this, c, b)
							}
							if (d == "painted" || d == "resize") {
								return this.element.doAddListener(d, f, e
										|| this, c, b)
							}
						...
						doRemoveListener : function(d, f, e, c, b) {
							if (c && "element" in c) {
								this[c.element].doRemoveListener(d, f, e
										|| this, c, b)
							}
							return this.callParent(arguments)
						},
						...
						alignTo : function(o, j) {
							var f = o.isComponent ? o.renderElement : o, c = this.renderElement, q = f
									.getPageBox(), B = this.getParent().element
									.getPageBox(), n = c.getPageBox(), y = q.height, p = q.width, t = n.height, v = n.width;
							B.bottom -= 5;
							B.height -= 10;
							B.left += 5;
							B.right -= 5;
							...
							var w = b[1].split(""), d = b[2].split(""), z = (b[3] === "?"), i = w[0], u = w[1]
									|| i, m = d[0], l = d[1] || m, r = q.top, e = q.left, k = y / 2, g = p / 2, h = v / 2, s = t / 2, x, A;
							switch (i) {
							case "t":
								switch (m) {
								case "c":
						...
						destroy : function() {
							...
							Ext.destroy(this.getTranslatable(), this
									.getPlugins());
							if (e) {
								e.remove(this, false)
							}
...
Ext.define("Ext.mixin.Bindable", {
	...
	bind : function(a, c, f, b) {
		if (!f) {
			f = c
		}
		var e = a[c], d;
		a[c] = d = function() {
			var i = d.$binding, h = i.bindingScope, g = Array.prototype.slice
					.call(arguments);
			g.push(arguments);
			if (!i.preventDefault && h[i.bindingMethod].apply(h, g) !== false) {
				return i.boundFn.apply(this, arguments)
			}
		};
		d.$binding = {
			preventDefault : !!b,
		...
		.define(
				"Ext.util.Wrapper",
				{
					...
					bindSize : function(b) {
						...
						this.boundMethodName = a = b === "width" ? "setWidth"
								: "setHeight";
...
Ext
		.define(
				"Ext.layout.wrapper.BoxDock",
				{
					...
					addItem : function(n) {
						var o = n.getDocked(), g = this.positionMap[o], a = n.$dockWrapper, b = this
								.getContainer(), h = b.indexOf(n), f = n.element, l = this.items, k = l[g], e, j, m, d, c;
						if (a) {
							a.removeItem(n)
						}
						n.$dockWrapper = this;
		...
		.define(
				"Ext.layout.Default",
				{
					...
					setContainer : function(a) {
						...
						a.on("centeredchange", "onItemCenteredChange", this, b,
								"before").on("floatingchange",
								"onItemFloatingChange", this, b, "before").on(
								"dockedchange", "onBeforeItemDockedChange",
								this, b, "before").on("afterdockedchange",
								"onAfterItemDockedChange", this, b)
					},
					monitorSizeStateChange : function() {
						this.monitorSizeStateChange = Ext.emptyFn;
						this.container.on("sizestatechange",
								"onContainerSizeStateChange", this)
					},
					monitorSizeFlagsChange : function() {
						this.monitorSizeFlagsChange = Ext.emptyFn;
						this.container.on("sizeflagschange",
								"onContainerSizeFlagsChange", this)
					},
					...
					onItemInnerStateChange : function(b, a, c) {
						if (a) {
							this.insertInnerItem(b, this.container
									.innerIndexOf(b))
						} else {
							this.removeInnerItem(b)
						}
					},
					insertInnerItem : function(e, c) {
						var a = this.container, g = a.innerElement.dom, d = e.element.dom, f = a
								.getInnerAt(c + 1), b = f ? f.element.dom
								: null;
						g.insertBefore(d, b);
						return this
					},
					...
					onAfterDockedChange : function(b, d, c) {
						var a = b.getParent();
						if (a && d) {
							a.getLayout().onAfterItemDockedChange(b, d, c)
						}
					},
					...
					refreshDockedItemLayoutSizeFlags : function(d) {
						var b = this.container, e = this.positionDirectionMap[d
								.getDocked()], c = (e === "horizontal") ? b.LAYOUT_HEIGHT
								: b.LAYOUT_WIDTH, a = (b.getSizeFlags() & c);
						d.setLayoutSizeFlags(a)
					},
					dockItem : function(r) {
						var b = Ext.layout.wrapper.BoxDock, o = this.dockedItems, g = o.length, h = this.container, s = h
								.indexOf(r), f = this.positionDirectionMap, t = f[r
								.getDocked()], q = this.dockInnerWrapper, k, l, u, e, p, j, m, a, d, n, c;
						this.monitorSizeStateChange();
						this.monitorSizeFlagsChange();
						if (!q) {
							q = this.link("dockInnerWrapper",
						...
						if (g === 0) {
							...
							n.addItem(r);
							n.getElement().replace(q.getElement());
							n.setInnerWrapper(q);
							...
							if (t === k) {
								...
								if (j.length > 0) {
									if (j.length === d.itemsCount) {
										c = d;
										n.setSizeState(c.getSizeState());
										n.getElement().replace(c.getElement())
									} else {
										c = new b({
											container : this.container,
											direction : k
									...
									n.setInnerWrapper(d.getInnerWrapper());
									d.setInnerWrapper(n)
								}
								n.addItem(r)
							}
						}
						h.onInitialized("refreshDockedItemLayoutSizeFlags",
								this, [ r ])
					},
		...
		.define(
				"Ext.layout.FlexBox",
				{
					...
					updateOrient : function(c, b) {
						...
						if (b) {
							a.un(b === "horizontal" ? "widthchange"
									: "heightchange", "onItemSizeChange", this,
									d);
							this.redrawContainer()
						}
						a.on(c === "horizontal" ? "widthchange"
								: "heightchange", "onItemSizeChange", this, d)
					},
					...
					refreshItemSizeState : function(e) {
						var c = e.isInnerItem(), a = this.container, f = a.LAYOUT_HEIGHT, d = a.LAYOUT_WIDTH, g = this.sizePropertyName, b = 0, h = a
								.getSizeFlags();
						if (c) {
					...
					updatePack : function(a, b) {
						this.container.innerElement.swapCls(a, b, true,
								"x-pack")
					}
				});
...
Ext.define("Ext.layout.Fit", {
	...
	onContainerSizeFlagsChange : function() {
		var a = this.container, b = a.getSizeFlags(), g = Boolean(b
				& a.LAYOUT_STRETCHED), f = a.innerItems, c, e, d;
		this.callSuper();
		for (c = 0, e = f.length; c < e; c++) {
			d = f[c];
...
Ext
		.define(
				"Ext.layout.wrapper.Dock",
				{
					...
					addItem : function(o) {
						var p = o.getDocked(), h = this.positionMap[p], b = o.$dockWrapper, c = this
								.getContainer(), j = c.indexOf(o), m = this.items, l = m[h], a, g, f, k, n, e, d;
						if (b) {
							b.removeItem(o)
						}
						o.$dockWrapper = this;
						...
						a.wrap(o.element);
						a
								.bindSize(this.getDirection() === "horizontal" ? "width"
										: "height")
					},
					removeItem : function(c) {
						var a = c.getDocked(), b = this.items[this.positionMap[a]];
...
Ext
		.define(
				"Ext.fx.animation.Slide",
				{
					...
					getData : function() {
						var p = this.getElementBox(), c = this
								.getContainerBox(), g = p ? p : c, n = this
...
Ext
		.define(
				"Ext.fx.animation.Flip",
				{
					...
					getData : function() {
						var h = this.getFrom(), i = this.getTo(), g = this
								.getDirection(), b = this.getOut(), l = this
								.getHalf(), c = (l) ? 90 : 180, e = 1, a = 1, k = 0, j = 0, f = 0, d = 0;
						if (b) {
							a = 0.8
						} else {
							e = 0.8
		...
		.define(
				"Ext.fx.layout.card.Scroll",
				{
					...
					stopAnimation : function() {
						...
						if (c.isReverse && d && d.renderElement
								&& d.renderElement.dom) {
...
Ext.define("Ext.layout.Card",
		{
			...
			onContainerInitialized : function() {
				var a = this.container, b = a.getActiveItem();
				if (b) {
					b.show()
				}
			...
			onItemInnerStateChange : function(c, b, d) {
				...
				if (b) {
					if (e !== a.innerIndexOf(c) && e !== c
							&& c !== a.pendingActiveItem) {
						c.hide()
					}
				} else {
...
Ext
		.define(
				"Ext.util.AbstractMixedCollection",
				{
					...
					get : function(b) {
						var d = this, a = d.map[b], c = a !== undefined ? a
								: (typeof b == "number") ? d.items[b]
										: undefined;
						return typeof c != "function" || d.allowFunctions ? c
								: null
					},
					getAt : function(a) {
						return this.items[a]
					...
					getRange : function(f, a) {
						...
						f = f || 0;
						a = Math.min(
								typeof a == "undefined" ? e.length - 1 : a,
								e.length - 1);
						if (f <= a) {
							for (d = f; d <= a; d++) {
								b[b.length] = c[d]
...
Ext.define("Ext.util.Sorter", {
	...
	toggle : function() {
		this
				.setDirection(Ext.String.toggle(this.getDirection(), "ASC",
						"DESC"))
	}
});
Ext
				...
				"Ext.util.Sortable",
				{
					...
					initSortable : function() {
						...
						a.sorters = Ext.create(
								"Ext.util.AbstractMixedCollection", false,
								function(c) {
					...
					decodeSorters : function(f) {
						...
						var d = f.length, g = Ext.util.Sorter, a = this.model ? this.model.prototype.fields
								: null, e, b, c;
						for (c = 0; c < d; c++) {
							b = f[c];
							if (!(b instanceof g)) {
		...
		.define(
				"Ext.util.MixedCollection",
				{
					...
					_sort : function(k, a, j) {
						var h = this, d, e, b = String(a).toUpperCase() == "DESC" ? -1
								: 1, g = [], l = h.keys, f = h.items;
						j = j || function(i, c) {
							return i - c
						};
...
Ext
		.define(
				...
				{
					extend : "Ext.fx.easing.Abstract",
					requires : [ "Ext.fx.easing.Momentum",
					...
					getValue : function() {
						var a = this.getMomentum(), j = this.getBounce(), e = a
								...
								.getMinMomentumValue(), d = this
								.getMaxMomentumValue(), c = (f == 1) ? d : g, h = this.lastValue, i, b;
						if (e === 0) {
						...
						if (!this.isOutOfBound) {
							...
							j.setStartTime(Ext.Date.now()).setStartVelocity(b)
									.setStartValue(c)
						}
						i = j.getValue();
						if (!this.isEnded) {
...
Ext
		.define(
				"Ext.fx.easing.EaseOut",
				{
					...
					getValue : function() {
						var f = Ext.Date.now() - this.getStartTime(), d = this
								.getDuration(), b = this.getStartValue(), h = this
								.getEndValue(), a = this.distance, c = f / d, g = 1 - c, e = 1 - Math
								.pow(g, this.getExponent()), i = b + (e * a);
						if (f >= d) {
							this.isEnded = true;
							return h
						}
...
Ext
		.define(
				...
				{
					extend : "Ext.Evented",
					requires : [ "Ext.fx.easing.BoundMomentum",
							"Ext.fx.easing.EaseOut", "Ext.util.Translatable" ],
					config : {
						element : null,
						direction : "auto",
						fps : "auto",
					...
					constructor : function(a) {
						...
						if (Ext.os.is.Android4 && !Ext.browser.is.Chrome) {
							this.onDrag = Ext.Function.createThrottled(
									this.onDrag, 20, this)
						}
						this.listeners = {
							scope : this,
					...
					updateElement : function(a) {
						...
						this.onConfigUpdate([ "containerSize", "size" ],
								"refreshMaxPosition");
					...
					applyDirection : function(a) {
						var e = this.getMinPosition(), d = this
								.getMaxPosition(), c, b;
					...
					updateAutoRefresh : function(a) {
						this.getElement().toggleListener(a, "resize",
								"onElementResize", this);
						this.getContainer().toggleListener(a, "resize",
								"onContainerResize", this)
					},
					...
					onAxisDrag : function(i, q) {
						...
						var h = this.flickStartPosition, l = this.flickStartTime, j = this.lastDragPosition, e = this.dragDirection, g = this.position[i], k = this
								...
								- q, c = e[i], m = this
								.getOutOfBoundRestrictFactor(), f = this
								.getStartMomentumResetTime(), b = Ext.Date
								.now(), a;
						if (n < k) {
							n *= m
						} else {
					...
					snapToSlot : function() {
						var b = this.getSnapPosition("x"), a = this
								.getSnapPosition("y"), c = this
								.getSlotSnapEasing();
						if (b !== null || a !== null) {
							this.scrollTo(b, a, {
								easingX : c.x,
				...
				"Ext.scroll.indicator.Abstract",
				{
					...
					refresh : function() {
						var f = this.barElement, e = f.dom, c = this.getRatio(), b = this
								.getAxis(), a = (b === "x") ? e.offsetWidth
								: e.offsetHeight, d = a * c;
						this.barLength = a;
						this.gapLength = a - d;
						this.setLength(d);
...
Ext.define("Ext.scroll.indicator.Default",
		{
			...
			updateValue : function(f) {
				var b = this.barLength, c = this.gapLength, d = this
						.getLength(), e, g, a;
				if (f <= 0) {
					g = 0;
		...
		.define(
				"Ext.scroll.indicator.ScrollPosition",
				{
					...
					updateLength : function() {
						var a = this.barLength, c = this.barElement.dom, b = this.element;
						this.callParent(arguments);
						if (this.getAxis() === "x") {
							c.scrollLeft = a;
							b.setLeft(a)
		...
		.define(
				"Ext.scroll.indicator.CssTransform",
				{
					...
					updateLength : function(c) {
						...
						if (b === "x") {
							a.webkitTransform = "translate3d(" + g
									+ "px, 0, 0)";
							e.webkitTransform = "translate3d(0, 0, 0) scaleX("
									+ f + ")"
						} else {
							a.webkitTransform = "translate3d(0, " + g
									+ "px, 0)";
							e.webkitTransform = "translate3d(0, 0, 0) scaleY("
									+ f + ")"
						}
					},
					updateValue : function(f) {
					...
					setOffset : function(c) {
						...
						c = Math.round(c);
						if (a === "x") {
							b.webkitTransform = "translate3d(" + c
									+ "px, 0, 0)"
						} else {
							b.webkitTransform = "translate3d(0, " + c
									+ "px, 0)"
						}
					}
				});
Ext.define("Ext.scroll.indicator.Throttled", {
	...
	constructor : function() {
		this.callParent(arguments);
		this.updateLength = Ext.Function.createThrottled(this.updateLength, 75,
				this);
	...
	updateLength : function(a) {
		a = Math.round(a);
		if (this.lastLength === a || this.lastOffset === -10000) {
			return
		}
		this.lastLength = a;
...
Ext.define("Ext.scroll.Indicator", {
	...
	constructor : function(a) {
		if (Ext.os.is.Android2 || Ext.os.is.Android3) {
			...
			if (Ext.os.is.iOS || Ext.browser.is.ChromeMobile) {
				return new Ext.scroll.indicator.CssTransform(a)
			} else {
				if (Ext.os.is.Android4) {
					return new Ext.scroll.indicator.Throttled(a)
				} else {
...
Ext.define("Ext.behavior.Scrollable", {
	...
	setConfig : function(d) {
		var b = this.scrollView, c = this.component, a;
		if (d) {
			if (!b) {
...
Ext.define("Ext.Container",
		{
			...
			requires : [ "Ext.layout.*", "Ext.ItemCollection",
			...
			applyItems : function(a, d) {
				if (a) {
					...
					b.add(a);
					if (b.initialized) {
						var c = b.initialConfig.activeItem
								|| b.config.activeItem || 0;
						b.setActiveItem(c)
					}
				}
			},
			...
			getLayout : function() {
				var a = this.layout;
				if (!a) {
					a = this.link("_layout", this.link("layout", Ext.factory(
							this._layout || "default", Ext.layout.Default,
							null, "layout")));
					a.setContainer(this)
				}
				return a
			...
			updateDefaultType : function(a) {
				this.defaultItemClass = Ext.ClassManager.getByAlias("widget."
						+ a)
			},
			...
			add : function(a) {
				...
				for (b = 0; b < d; b++) {
					c = e.factoryItem(a[b]);
					this.doAdd(c);
					if (!f && !this.getActiveItem()
							&& this.innerItems.length > 0 && c.isInnerItem()) {
						f = c
					}
				}
				if (f) {
			...
			insertInner : function(d, b) {
				var a = this.getItems().items, f = this.innerItems, g = f
						.indexOf(d), c = -1, e;
				if (g !== -1) {
					f.splice(g, 1)
				}
			...
			doItemLayoutAdd : function(c, a) {
				...
				if (this.isRendered() && c.setRendered(true)) {
					c.fireAction("renderedchange", [ this, c, true ],
							"onItemAdd", b, {
								args : [ c, a ]
							})
				} else {
			...
			doItemLayoutRemove : function(c, a) {
				...
				if (this.isRendered() && c.setRendered(false)) {
					c.fireAction("renderedchange", [ this, c, false ],
							"onItemRemove", b, {
								args : [ c, a, undefined ]
							})
				} else {
			...
			getScrollableBehavior : function() {
				...
				if (!a) {
					a = this.scrollableBehavior = new Ext.behavior.Scrollable(
							this)
				}
				return a
			},
				...
				"Ext.util.Point",
				{
					...
					statics : {
						fromEvent : function(b) {
							var a = b.changedTouches, c = (a && a.length > 0) ? a[0]
									: b;
					...
					isCloseTo : function(c, b) {
						...
						return (this.x <= a + e && this.x >= a - e
								&& this.y <= f + d && this.y >= f - d)
					},
					isWithin : function() {
				...
				"Ext.util.LineSegment",
				{
					...
					intersects : function(l) {
						...
						e = ((k - h) * (c * n - p * b) - (p - n)
								* (a * h - k * q))
								/ g;
						if (j < Math.min(c, b) || j > Math.max(c, b)
								|| j < Math.min(a, q) || j > Math.max(a, q)
								|| e < Math.min(p, n) || e > Math.max(p, n)
								|| e < Math.min(k, h) || e > Math.max(k, h)) {
							return null
						}
		...
		.define(
				"Ext.Panel",
				{
					...
					alignTo : function(m) {
						...
						this.callParent(arguments);
						var f = Ext.util.LineSegment, d = m.isComponent ? m.renderElement
								: m, a = this.renderElement, n = d.getPageBox(), k = a
								.getPageBox(), b = k.left, t = k.top, C = k.right, h = k.bottom, j = b
						...
						if (c.intersects(new f(o, l))) {
							...
							if (c.intersects(new f(o, B))) {
								x = b;
								u = Math.min(Math.max(q + (z / 2), z * 1.6), h
										- (z / 2.2));
								g = r + 10;
								p = "left"
							} else {
...
Ext
		.define(
				"Ext.data.Connection",
				{
					...
					request : function(j) {
						j = j || {};
						var f = this, i = j.scope || window, e = j.username
								|| f.getUsername(), g = j.password
						...
						if (f.fireEvent("beforerequest", f, j) !== false) {
							...
							b = j.async !== false ? (j.async || f.getAsync())
									: false;
							if (e) {
							...
							f.requests[d.id] = d;
							if (b) {
								h.onreadystatechange = Ext.Function.bind(
										f.onStateChange, f, [ d ])
							}
							h.send(c.data);
							if (!b) {
							...
							Ext.callback(j.callback, j.scope, [ j, undefined,
									undefined ]);
							return null
						}
					},
					upload : function(e, c, i, k) {
						...
						if (i) {
							Ext.iterate(Ext.Object.fromQueryString(i),
									function(l, m) {
										if (Ext.isArray(m)) {
					...
					setOptions : function(k, j) {
						var h = this, e = k.params || {}, g = h
								.getExtraParams(), d = k.urlParams, c = k.url
						...
						b = (k.method || h.getMethod() || ((e || f) ? "POST"
								: "GET")).toUpperCase();
					...
					setupHeaders : function(l, m, d, c) {
						var h = this, b = Ext.apply({}, m.headers || {}, h
								.getDefaultHeaders()
				...
				function() {
						...
						if (c.isAnim) {
							...
							if (Ext.isObject(c)) {
								if (a.before && c.before) {
									a.before = Ext.createInterceptor(a.before,
											c.before, c.scope)
								}
								if (a.after && c.after) {
									a.after = Ext.createInterceptor(a.after,
											c.after, c.scope)
								}
								a = Ext.apply({}, a, c);
								c = c.type
					...
					Ext.anims = {
						...
						slide : new Ext.Anim(
								{
									...
									"z-index" : false,
									before : function(a) {
										var c = a.getStyle("z-index") == "auto" ? 0
												: a.getStyle("z-index"), f = a
						...
						pop : new Ext.Anim({
							scaleOnExit : true,
							before : function(d) {
								var b = 1, c = 1, g = 1, a = 1, h = d
										.getStyle("z-index") == "auto" ? 0 : d
										.getStyle("z-index"), f = h, e = h;
								if (!this.out) {
									b = 0.01;
									f = h + 1;
									e = h + 1;
		...
		.define(
				...
				function() {
					var g = this, j = [ "var r = [],", "i = 0,", "it = items,",
						...
						for (; p < s; p++) {
							q = o[p];
							if (q.el ? q.el.hasCls(r) : t.contains(q.initCls(),
									r)) {
								n.push(q)
							}
						}
					...
					g.Query = Ext
							.extend(
									Object,
									{
										...
										is : function(p) {
											var o = this.operations, s = Ext
													.isArray(p) ? p : [ p ], n = s.length, t = o[o.length - 1], r, q;
											s = e(s, t);
											if (s.length === n) {
												if (o.length > 1) {
...
Ext.define("Ext.Img", {
	...
	doSetWidth : function(b) {
		var a = (this.getMode() === "background") ? this.element
				: this.imageElement;
		a.setWidth(b);
		this.callParent(arguments)
	},
...
Ext.define("Ext.Map", {
	...
	renderMap : function() {
		var d = this, f = (window.google || {}).maps, b = d.mapContainer, a = d
		...
		.define(
				"Ext.field.Text",
				{
					...
					updateValue : function(c) {
						var b = this.getComponent(), a = c !== undefined
								&& c !== null && c !== "";
						if (b) {
							b.setValue(c)
						}
					...
					showClearIcon : function() {
						var b = this, c = b.getValue(), a = c !== undefined
								&& c !== null && c !== "";
						if (b.getClearIcon() && !b.getDisabled()
								&& !b.getReadOnly() && a) {
							b.element.addCls(Ext.baseCSSPrefix
									+ "field-clearable")
						}
						return b
					},
					hideClearIcon : function() {
						if (this.getClearIcon()) {
							this.element.removeCls(Ext.baseCSSPrefix
									+ "field-clearable")
						}
					},
					onKeyUp : function(a) {
					...
					doKeyUp : function(b, d) {
						var c = b.getValue(), a = c !== undefined && c !== null
								&& c !== "";
						this[a ? "showClearIcon" : "hideClearIcon"]();
					...
					onClearIconTap : function(a) {
						this.fireAction("clearicontap", [ this, a ],
								"doClearIconTap")
					},
		...
		.define(
				"Ext.MessageBox",
				{
					...
					requires : [ "Ext.Toolbar", "Ext.field.Text",
							"Ext.field.TextArea" ],
					config : {
						ui : (Ext.os.is.BlackBerry && Ext.os.version.getMajor() === 10) ? "plain"
								: "dark",
					...
					constructor : function(a) {
						...
						if (a.hasOwnProperty("multiline")
								|| a.hasOwnProperty("multiLine")) {
							a.prompt = a.prompt || {};
						...
						var e = [ "ui", "showAnimation", "hideAnimation",
								"title", "message", "prompt", "iconCls",
								"buttons", "defaultTextHeight" ], d = e.length, b, c;
						for (b = 0; b < d; b++) {
							c = e[b];
					...
					applyTitle : function(a) {
						...
						Ext.applyIf(a, {
							docked : "top",
							minHeight : (Ext.os.is.BlackBerry && Ext.os.version
									.getMajor() === 10) ? "2.1em" : "1.3em",
					...
					applyPrompt : function(a) {
						if (a) {
							...
							if (b.multiLine) {
								b.height = Ext.isNumber(b.multiLine) ? parseFloat(b.multiLine)
										: this.getDefaultTextHeight();
								return Ext.factory(b, Ext.field.TextArea, this
										.getPrompt())
							} else {
								return Ext.factory(b, Ext.field.Text, this
										.getPrompt())
							}
						}
						return a
					...
					onClick : function(c) {
						if (c) {
							var b = c.config.userConfig || {}, d = c
									.getInitialConfig(), a = this.getPrompt();
							if (typeof b.fn == "function") {
								this.on({
									hiddenchange : function() {
										b.fn.call(b.scope || null, d.itemId
												|| d.text, a ? a.getValue()
												: null, b)
									},
									single : true,
		...
		.define(
				"Ext.SegmentedButton",
				{
					...
					updateAllowMultiple : function(a) {
						if (!this.initialized
								&& !this.getInitialConfig().hasOwnProperty(
										"allowDepress") && a) {
					...
					updateFirstAndLastCls : function(b) {
						var e = b.length, f = Ext.baseCSSPrefix, a = f
								+ "first", g = f + "last", d, c;
						for (c = 0; c < e; c++) {
							d = b.items[c];
							d.removeCls(a);
		...
		.define(
				"Ext.Sortable",
				{
					...
					constructor : function(b, a) {
						...
						this.startEventName = (this.getDelay() > 0) ? "taphold"
								: "tapstart";
						if (!this.disabled) {
							this.enable()
						}
...
(function() {
	...
	for (a = 0; a < b && !window.requestAnimationFrame; ++a) {
		...
		window.cancelAnimationFrame = window[d + "CancelAnimationFrame"]
				|| window[d + "CancelRequestAnimationFrame"]
	}
	if (!window.requestAnimationFrame) {
		window.requestAnimationFrame = function(j, g) {
			var f = new Date().getTime(), h = Math.max(0, 16 - (f - c)), i = window
					.setTimeout(function() {
						j(f + h)
					}, h);
			c = f + h;
...
Ext
		.define(
				"Ext.TitleBar",
				{
					...
					maxButtonWidth : "40%",
					constructor : function() {
						this.refreshTitlePosition = Ext.Function
								.createThrottled(this.refreshTitlePosition, 50,
										this);
						this.callParent(arguments)
					},
					beforeInitialize : function() {
					...
					refreshTitlePosition : function() {
						...
						g.setWidth(null);
						g.setLeft(null);
						var b = this.leftBox, d = b.down("button"), a = b
								.getItems().getCount() == 1, i, n;
						if (d && a) {
							if (d.getWidth() == null) {
						...
						var k = this.spacer.renderElement.getPageBox(), l = g
								.getPageBox(), h = l.width - k.width, e = l.left, j = l.right, c, m, f;
						if (h > 0) {
							g.setWidth(k.width);
							c = h / 2;
							e += c;
		...
		.define("Ext.Video",
				{
					...
					updateUrl : function(f) {
						var c = this, e = c.media, g = f.length, d = e
								.query("source"), b = d.length, a;
						for (a = 0; a < b; a++) {
							Ext.fly(d[a]).destroy()
						}
						for (a = 0; a < g; a++) {
...
Ext
		.define(
				"Ext.app.Action",
				{
					...
					resume : function() {
						var b = this.getCurrentFilterIndex() + 1, c = this
								.getBeforeFilters(), a = this.getController(), d = c[b];
						if (d) {
		...
		.define(
				"Ext.app.Controller",
				{
					...
					applyRoutes : function(a) {
						var f = this instanceof Ext.app.Application ? this
								: this.getApplication(), c = f.getRouter(), b, e, d;
						for (e in a) {
							b = a[e];
							d = {
						...
						for (f in b) {
							...
							if (!this[c]) {
								...
								this[c] = function(i, h) {
									var g = [ i, h ];
									return function() {
										return d.getRef.apply(d, g.concat
												.apply(g, arguments))
									}
								}(f, e)
							}
					...
					getRef : function(d, e, a) {
						...
						if (!b) {
							c.refCache[d] = b = Ext.ComponentQuery
									.query(e.selector)[0];
							if (!b && e.autoCreate) {
		...
		.define(
				"Ext.app.Profile",
				{
					...
					getDependencies : function() {
						var c = [], g = Ext.String.format, b = this
								.getApplication().getName(), d = this
								.getNamespace(), f = {
...
Ext
		.define(
				"Ext.app.Application",
				{
					...
					requires : [ "Ext.app.History", "Ext.app.Profile",
							"Ext.app.Router", "Ext.app.Action" ],
					config : {
						profiles : [],
						controllers : [],
						history : {},
					...
					constructor : function(a) {
						...
						Ext.require(this.getRequires(), function() {
							if (this.getEnableLoader() !== false) {
								Ext.require(this.getProfiles(),
										this.onProfilesLoaded, this)
							}
						}, this)
					},
					dispatch : function(e, d) {
						...
						if (e) {
							var c = this.getCurrentProfile(), b = c ? c
									.getNamespace() : undefined, a = this
									.getController(e.getController(), b);
							if (a) {
								if (d !== false) {
					...
					redirectTo : function(c) {
						if (Ext.data && Ext.data.Model
								&& c instanceof Ext.data.Model) {
							var a = c;
							c = a.toUrl()
						}
					...
					control : function(h, d) {
						d = d || this;
						var i = this.getEventDispatcher(), g = (d) ? d
								.getRefs() : {}, c, e, b, f, a;
						for (c in h) {
					...
					getController : function(b, d) {
						var f = this.getControllerInstances(), a = this
								.getName(), e = Ext.String.format, c;
					...
					onProfilesLoaded : function() {
						...
						for (c = 0; c < e; c++) {
							...
							if (g[c].isActive() && !f) {
								...
								this.setControllers(this.getControllers()
										.concat(a.controller));
								this
										.setModels(this.getModels().concat(
												a.model));
								this.setViews(this.getViews().concat(a.view));
								this
										.setStores(this.getStores().concat(
												a.store))
							}
						}
					...
					loadControllerDependencies : function() {
						...
						for (d in g) {
							...
							a = b.getStores();
							c = c.concat(a);
							f = f.concat(b.getModels().concat(b.getViews())
									.concat(a))
						}
					...
					onDependenciesLoaded : function() {
						var c = this, b = this.getCurrentProfile(), e = this
								.getLaunch(), d, a;
					...
					gatherDependencies : function() {
						var a = this.getModels().concat(this.getViews())
					...
					applyHistory : function(a) {
						var b = Ext.factory(a, Ext.app.History, this
								.getHistory());
		...
		.define(
				"Ext.util.TranslatableGroup",
				{
					...
					doTranslate : function(n, m) {
						var l = this.getItems(), p = this.getActiveIndex(), j = this
								.getItemLength(), d = j.x, c = j.y, h = typeof n == "number", g = typeof m == "number", e, f, k, o, b, a;
						for (f = 0, k = l.length; f < k; f++) {
							o = l[f];
							if (o) {
								e = (f - p);
		...
		.define(
				"Ext.carousel.Carousel",
				{
					...
					updateBufferSize : function(n) {
						var l = Ext.carousel.Item, h = n * 2 + 1, m = this
								.isRendered(), c = this.innerElement, g = this.carouselItems, f = g.length, e = this
								.getItemConfig(), d = this.getItemLength(), j = this
								.getDirection(), b = j === "horizontal" ? "setWidth"
								: "setHeight", a, k;
						for (a = f; a < h; a++) {
							k = Ext.factory(e, l);
							if (d) {
					...
					onItemAdd : function(c, b) {
						this.callParent(arguments);
						var d = this.getInnerItems().indexOf(c), a = this
								.getIndicator();
						if (a && c.isInnerItem()) {
							a.addIndicator()
						}
					...
					onItemRemove : function(f, b) {
						this.callParent(arguments);
						var h = this.getInnerItems().indexOf(f), a = this
								.getIndicator(), d = this.carouselItems, c, e, g;
						if (f.isInnerItem() && a) {
							a.removeIndicator()
						}
					...
					onDrag : function(j) {
						...
						var k = this.dragStartOffset, l = this.getDirection(), m = l === "horizontal" ? j.deltaX
								: j.deltaY, a = this.offset, i = this.flickStartTime, c = this.dragDirection, b = Ext.Date
								.now(), h = this.getActiveIndex(), f = this
								.getMaxItemIndex(), d = c, g;
						if ((h === 0 && m > 0) || (h === f && m < 0)) {
							m *= 0.5
						}
						g = k + m;
					...
					onDragEnd : function(j) {
						...
						var a = Ext.Date.now(), i = this.itemLength, g = i / 2, f = this.offset, m = this
								...
								- this.flickStartOffset, b = a
								- this.flickStartTime, k = this.getIndicator(), d;
					...
					setOffset : function(a) {
						this.offset = a;
						this.getTranslatable().translateAxis(this.currentAxis,
								a + this.itemOffset);
						return this
					},
					setOffsetAnimated : function(b) {
						var a = this.getIndicator();
						if (a) {
							a.setActiveIndex(this.getActiveIndex()
									- this.animationDirection)
						}
						this.offset = b;
						this.getTranslatable().translateAxis(this.currentAxis,
								b + this.itemOffset, this.getAnimation());
						return this
					},
					...
					refreshActiveIndex : function() {
						this.activeIndex = this.getInnerItemIndex(this
								.getActiveItem())
					},
					...
					doSetActiveItem : function(g) {
						var q = this.getActiveIndex(), e = this
								.getMaxItemIndex(), m = this.getIndicator(), c = this
								.getBufferSize(), k = this.carouselItems
				...
				"Ext.carousel.Infinite",
				{
					...
					rebuildInnerIndexes : function(n) {
						var c = this.innerIndexToItem, g = this.innerIdToIndex, j = this.innerItems
								.slice(), h = j.length, b = this
								.getBufferSize(), d = this.getMaxItemIndex(), l = [], e, k, f, a, m;
						if (n === undefined) {
							...
							for (e = 0; e < h; e++) {
								...
								g[a] = e;
								c[e] = m;
								this.fireEvent("itemindexchange", this, m, e,
										-1)
							}
						} else {
							for (e = n - b; e <= n + b; e++) {
							...
							for (e = 0, h = l.length; e < h; e++) {
								...
								c[f] = m;
								this
										.fireEvent("itemindexchange", this, m,
												f, k)
							}
						}
					},
					...
					applyActiveItem : function(c) {
						this.getItems();
						this.getBufferSize();
						var b = this.getMaxItemIndex(), a = this
								.getActiveIndex();
						if (typeof c == "number") {
...
Ext.define("Ext.mixin.Filterable",
		{
			...
			insertFilters : function(h, c) {
				...
				var j = c.length, a = this.getFilterRoot(), d = this
						.getFilters(), e = [], f, g, b;
				if (!d) {
			...
			updateFilterFn : function() {
				...
				this.filterFn = function(h) {
					...
					for (b = 0; b < g; b++) {
						var e = a[b], d = e.getFilterFn(), c = e.getScope()
								|| this;
						f = f && d.call(c, h)
					}
					return f
			...
			isFiltered : function(a) {
				return this.getFilters().length ? !this.getFilterFn()(a)
						: false
			},
		...
		.define(
				"Ext.util.Collection",
				{
					...
					insertSorters : function() {
						this.mixins.sortable.insertSorters.apply(this,
								arguments);
					...
					applyFilters : function(a) {
						var b = this.mixins.filterable.applyFilters.call(this,
								a);
					...
					removeFilters : function(a) {
						...
						if (this.filtered && this.all.length
								&& this.getAutoFilter()) {
							this.filter()
						}
						return this
					...
					filter : function(c, b, d, a) {
						...
						this.items = this.mixins.filterable.filter.call(this,
								this.all.slice());
					...
					add : function(i, k) {
						...
						h.push(k);
						if (d && this.getAutoFilter()
								&& a.isFiltered.call(g, k)) {
							return null
						}
						g.length++;
					...
					insertAll : function(g, d) {
						if (g >= this.items.length
								|| (this.sorted && this.getAutoSort())) {
					...
					get : function(b) {
						...
						return typeof c != "function" || d.getAllowFunctions() ? c
								: null
					},
					getAt : function(a) {
						return this.items[a]
...
Ext.define("Ext.dataview.component.DataItem",
		{
			...
			updateRecord : function(d) {
				...
				this._record = d;
				var f = this, a = f.dataview || this.getDataview(), g = a
						.prepareData(d.getData(true), a.getStore().indexOf(d),
								d), c = f.getItems(), e = c.first(), b = f
						.getDataMap();
				if (!e) {
					return
				}
				...
				"Ext.dataview.component.Container",
				{
					...
					moveItemsToCache : function(j, k) {
						var h = this, c = h.dataview, a = c.getMaxItemCache(), g = h
								...
								.getPressedCls(), d = c.getSelectedCls(), b = k
								- j, m;
						for (; b >= 0; b--) {
							m = g[j + b];
							if (e !== a) {
...
Ext
		.define(
				"Ext.dataview.element.Container",
				{
					...
					onItemTouchStart : function(d) {
						var b = this, c = d.getTarget(), a = b.getViewItems()
								.indexOf(c);
						Ext.get(c).on({
							touchmove : "onItemTouchMove",
							scope : b,
					...
					updateListItem : function(b, f) {
						var e = this, a = e.dataview, c = a.getStore(), d = c
								.indexOf(b), g = a.prepareData(b.getData(true),
								d, b);
						g.xcount = c.getCount();
					...
					addListItem : function(e, c) {
						var h = this, d = h.dataview, i = d.getStore(), a = d
								.prepareData(c.getData(true), e, c), b = h.element, j = b.dom.childNodes, g = j.length, f;
						a.xcount = typeof a.xcount === "number" ? a.xcount : i
								.getCount();
					...
					getItemElementConfig : function(c, e) {
						var b = this.dataview, d = b.getItemCls(), a = b
								.getBaseCls()
								+ "-item";
						if (d) {
							a += " " + d
					...
					getViewItems : function() {
						return Array.prototype.slice
								.call(this.element.dom.childNodes)
					},
					updateAtNewIndex : function(c, b, a) {
						this.moveItemsToCache(c, c);
						this.moveItemsFromCache([ a ])
		...
		.define(
				"Ext.mixin.Selectable",
				{
					...
					fireSelectionChange : function(a) {
						var b = this;
						b.fireAction("selectionchange", [ b, a ],
								"getSelection")
					},
...
Ext.define("Ext.dataview.DataView", {
	...
	initialize : function() {
		...
		a = b.container = this
				.add(new Ext.dataview[b.getUseComponents() ? "component"
						: "element"].Container({
	...
	doRefresh : function(g) {
		var a = g.container, l = g.getStore(), b = l.getRange(), f = g
				.getViewItems(), j = b.length, o = f.length, c = j - o, h = g
				.getScrollable(), d, m;
	...
	onStoreUpdate : function(c, b, d, f) {
		...
		if (f !== d) {
			a.updateAtNewIndex(f, d, b);
			if (e.isSelected(b)) {
				e.doItemSelect(e, b)
			}
		} else {
			a.updateListItem(b, e.getViewItems()[d])
		}
	}
});
Ext
				...
				"Ext.data.Operation",
				{
					...
					applyModel : function(a) {
						if (typeof a == "string") {
							...
							if (!a) {
								Ext.Logger.error("Model with name "
										+ arguments[0] + " doesnt exist.")
							}
						}
						if (a && !a.prototype.isModel && Ext.isObject(a)) {
							a = Ext.data.ModelManager.registerType(a.storeId
									|| a.id || Ext.id(), a)
						}
						return a
					},
					...
					process : function(d, b, c, a) {
						...
						return this["process" + Ext.String.capitalize(d)].call(
								this, b, c, a)
					},
...
Ext
		.define(
				"Ext.data.reader.Reader",
				{
					...
					alternateClassName : [ "Ext.data.Reader",
							"Ext.data.DataReader" ],
					mixins : [ "Ext.mixin.Observable" ],
					isReader : true,
					config : {
					...
					buildExtractors : function() {
						...
						var b = this, c = b.getTotalProperty(), a = b
								.getSuccessProperty(), d = b
								.getMessageProperty();
						if (c) {
					...
					buildRecordDataExtractor : function() {
						...
						for (d = 0; d < j; d++) {
							...
							if (m === e.getIdProperty()
									&& l.getMapping() === null
									&& e.getIdProperty() !== this
											.getIdProperty()) {
								l.setMapping(this.getIdProperty())
							}
							b.push("        try {\n");
							b.push("            value = ",
									k.createFieldAccessExpression(l, c,
											"source"), ";\n");
							b.push("            if (value !== undefined) {\n");
							b.push('                dest["' + l.getName()
									+ '"] = value;\n');
							b.push("            }\n");
							b.push("        } catch(e){}\n")
						}
						if (h) {
							...
							b
									.push('            dest["_clientId"] = internalId;\n        }\n')
						}
						b.push("        return dest;\n");
						b.push("    };");
					...
					onMetaChange : function(f) {
						...
						if (a) {
							if (e.getModel()) {
								...
								d = Ext.define("Ext.data.reader.MetaModel"
										+ Ext.id(), {
...
Ext.define("Ext.data.reader.Json", {
	...
	createAccessor : function() {
		...
		return function(c) {
			...
			if (this.getUseSimpleAccessors() !== true) {
				...
				if (b >= 0) {
					return Ext.functionFactory("obj",
							"var value; try {value = obj" + (b > 0 ? "." : "")
									+ c + "} catch(e) {}; return value;")
				}
			}
			return function(d) {
				return d[c]
	...
	createFieldAccessExpression : function(g, b, c) {
		var f = this, h = f.objectRe, e = (g.getMapping() !== null), a = e ? g
				.getMapping() : g.getName(), i, d;
		...
		.define(
				"Ext.data.writer.Writer",
				{
					...
					getRecordData : function(e) {
						var j = e.phantom === true, b = this
								.getWriteAllFields()
								|| j, c = this.getNameProperty(), f = e
								.getFields(), d = {}, h, a, g, k, i;
						if (b) {
							f.each(function(l) {
								if (l.getPersist()) {
...
Ext.define("Ext.data.proxy.Proxy", {
	...
	updateReader : function(a) {
		if (a) {
			...
			if (a.onMetaChange) {
				a.onMetaChange = Ext.Function.createSequence(a.onMetaChange,
					...
					Ext
							.apply(
									b,
									{
										...
										STRING : {
											convert : function(c) {
												return (c === undefined || c === null) ? (this
														.getAllowNull() ? null
														: "")
														: String(c)
											},
										...
										INT : {
											convert : function(c) {
												return (c !== undefined
														&& c !== null && c !== "") ? ((typeof c === "number") ? parseInt(
														c, 10)
														: parseInt(
																String(c)
																		.replace(
		...
		.define(
				"Ext.data.proxy.Server",
				{
					...
					buildRequest : function(a) {
						var c = this, d = Ext.applyIf(a.getParams() || {}, c
								.getExtraParams()
								|| {}), b;
					...
					getParams : function(i) {
						var n = this, h = {}, a = i.getGrouper(), m = i
								.getSorters(), f = i.getFilters(), l = i
								.getPage(), d = i.getStart(), g = i.getLimit(), o = n
								.getSimpleSortMode(), q = n.getPageParam(), k = n
								.getStartParam(), p = n.getLimitParam(), j = n
								.getGroupParam(), e = n.getSortParam(), c = n
								.getFilterParam(), b = n.getDirectionParam();
					...
					getUrl : function(a) {
						return a ? a.getUrl() || this.getApi()[a.getAction()]
								|| this._url : this._url
					},
		...
		.define(
				"Ext.data.association.Association",
				{
					...
					statics : {
						create : function(a) {
							if (!a.isAssociation) {
								...
								return Ext.factory(a,
										Ext.data.association.Association, null,
										"association")
							}
							return a
						}
					...
					applyReader : function(a) {
						...
						return Ext.factory(a, Ext.data.Reader,
...
Ext.define("Ext.data.association.HasMany",
		{
			...
			applyAssociationKey : function(a) {
				if (!a) {
					...
					a = Ext.util.Inflector.pluralize(b[0].toLowerCase()
							+ b.slice(1))
				}
				return a
			},
			...
			applyStore : function(b) {
				var f = this, d = f, j = f.getAssociatedModel(), g = f
						.getStoreName(), e = f.getForeignKey(), i = f
						.getPrimaryKey(), h = f.getFilterProperty(), c = f
						.getAutoLoad(), a = f.getAutoSync();
				return function() {
					var l = this, n, p, m, k = {}, o = {
					...
					if (l[g] === undefined) {
						...
						m = l[g] = Ext.create("Ext.data.Store", n);
						m.boundTo = l;
						if (c) {
							l[g].load()
						}
			...
			getInverseAssociation : function() {
				...
				return this.getAssociatedModel().associations
						.findBy(function(b) {
		...
		.define(
				"Ext.data.association.BelongsTo",
				{
					...
					createSetter : function() {
						var d = this, c = d.getForeignKey(), f = d
								.getAssociatedModel(), e, a, b;
						return function(k, i, j) {
							...
							e = Ext.data.Model.cache[Ext.data.Model
									.generateCacheId(f.modelName, this.get(c))];
							a = Ext.data.Model.cache[Ext.data.Model
									.generateCacheId(f.modelName, k)];
							g.set(c, k);
							if (h) {
								if (a) {
					...
					createGetter : function() {
						var c = this, d = c.getAssociatedModel(), b = c
								.getForeignKey(), a = c.getInstanceName();
						return function(h, i) {
							h = h || {};
...
Ext
		.define(
				"Ext.data.association.HasOne",
				{
					...
					applyForeignKey : function(b) {
						if (!b) {
							...
							if (a) {
								...
								b = this.getAssociatedName().toLowerCase()
										+ "_id"
							}
						}
						return b
					...
					createSetter : function() {
						var c = this, b = c.getForeignKey(), a = c
								.getInstanceName(), d = c.getAssociatedModel();
		...
		.define(
				"Ext.data.Model",
				{
					...
					requires : [ "Ext.util.Collection", "Ext.data.Field",
							...
							"Ext.data.ModelManager", "Ext.data.proxy.Ajax",
							"Ext.data.association.HasMany",
							"Ext.data.association.BelongsTo",
							"Ext.data.association.HasOne", "Ext.data.Errors" ],
					config : {
						idProperty : "id",
						data : null,
						fields : undefined,
					...
					staticConfigs : [ "idProperty", "fields", "validations",
							"associations", "hasMany", "hasOne", "belongsTo",
							"clientIdProperty", "identifier", "useCache",
							"proxy" ],
					statics : {
						EDIT : "edit",
						REJECT : "reject",
					...
					constructor : function(f, h, c, g) {
						var e = this, d = null, a = e.getUseCache(), b = e
								.getIdProperty();
						e.modified = {};
						e.raw = c || f || {};
						e.stores = [];
						...
						h = f[b];
						if (a && (h || h === 0)) {
							d = Ext.data.Model.cache[Ext.data.Model
									.generateCacheId(this, h)];
							if (d) {
						...
						h = e.data[b];
						if (!h && h !== 0) {
							e.data[b] = e.internalId = e.id = e.getIdentifier()
									.generate(e);
							e.phantom = true;
						...
						if (a) {
							Ext.data.Model.cache[Ext.data.Model
									.generateCacheId(e)] = e
						}
					...
					mergeData : function(a) {
						var g = this, e = g.getFields().items, f = e.length, k = g.modified, c = g.data, d, h, l, j, b;
						for (d = 0; d < f; d++) {
							h = e[d];
							l = h._name;
							j = a[l];
							if (j !== undefined && !k.hasOwnProperty(l)) {
								if (h._convert) {
									j = h._convert(j, g)
								}
								c[l] = j
						...
						if (g.associations.length) {
							g.handleInlineAssociationData(a)
						}
						return this
					},
					setData : function(a) {
						var k = this, g = k.fields.items, h = g.length, f = Ext
								.isArray(a), d = k._data = k.data = {}, e, l, b, m, j, c;
						if (!a) {
							return k
						}
						for (e = 0; e < h; e++) {
					...
					setId : function(b) {
						...
						this.internalId = b;
						if (this.getUseCache()) {
							delete Ext.data.Model.cache[Ext.data.Model
									.generateCacheId(this, a)];
							Ext.data.Model.cache[Ext.data.Model
									.generateCacheId(this)] = this
						}
					},
					getId : function() {
					...
					endEdit : function(a, c) {
						...
						if (b.editing) {
							...
							if (a !== true && (b.changedWhileEditing())) {
								b.afterEdit(c
										|| Ext.Object.getKeys(this.modified),
										this.modified)
							}
					...
					save : function(b, d) {
						var e = this, f = e.phantom ? "create" : "update", c = e
								.getProxy(), a, g;
						if (!c) {
							Ext.Logger
					...
					afterCommit : function(a) {
						this.notifyStores("afterCommit", Ext.Object.getKeys(a
								|| {}), a)
					},
					...
					copy : function(c) {
						var d = this, b = d.getIdProperty(), a = Ext.apply({},
								d.raw), e = Ext.apply({}, d.data);
						delete a[b];
						delete e[b];
								...
								if (f && f.getCount() > 0) {
									...
									for (k = 0; k < r; k++) {
										...
										if (Ext.Array.indexOf(a, c) == -1) {
											a.push(c);
											e[s][k] = q.getData();
											Ext.apply(e[s][k], this
													.prepareAssociatedData(q,
															a, n))
										}
									}
								}
					...
					validate : function() {
						var j = Ext.create("Ext.data.Errors"), c = this
								.getValidations().items, e = Ext.data.Validations, b, d, h, a, g, f;
						if (c) {
							b = c.length;
							for (f = 0; f < b; f++) {
								d = c[f];
					...
					toUrl : function() {
						var b = this.$className.split("."), a = b[b.length - 1]
								.toLowerCase();
						return a + "/" + this.getId()
					},
					destroy : function() {
					...
					addAssociations : function(e, h) {
						...
						for (d = 0, f = e.length; d < f; d++) {
							...
							a = Ext.Function.bind(function(i) {
								g.add(Ext.data.association.Association
										.create(this))
							}, b);
							Ext.ClassManager
									.onCreated(
											a,
											this,
											(typeof b.associatedModel === "string") ? b.associatedModel
													: Ext
															.getClassName(b.associatedModel))
						}
					},
					...
					updateFields : function(c) {
						...
						f = e._fields = e.fields = new Ext.util.Collection(
								h.getFieldName);
						for (b = 0; b < d; b++) {
							g = c[b];
							if (!g.isField) {
					...
					applyIdentifier : function(a) {
						...
						return Ext.factory(a, Ext.data.identifier.Simple, this
								.getIdentifier(), "data.identifier")
					},
					...
					onClassExtended : function(k, d, j) {
						...
						j.onBeforeCreated = function(A, t) {
							var v = [], x = A.prototype, w = {}, m = x.config, n = g.length, q = [
									"set", "get" ], s = q.length, o = m.associations
									|| [], l = Ext.getClassName(A), z, y, r, p, u;
							for (r = 0; r < n; r++) {
								z = g[r];
								for (p = 0; p < s; p++) {
									y = e[z][q[p]];
												...
												Ext.Function
														.interceptBefore(
																...
																function() {
																	...
																	A.prototype.associations = A.associations = A.prototype._associations = (B && B.associations) ? B.associations
																			.clone()
																	...
																	A.prototype.validations = A.validations = A.prototype._validations = (B && B.validations) ? B.validations
																			.clone()
																			: new Ext.util.Collection(
																					function(
																							C) {
																	...
																	A.prototype = Ext.Object
																			.chain(A.prototype);
																	A.prototype.initConfig
																			.call(
																					A.prototype,
																					m);
		...
		.define(
				"Ext.data.Store",
				{
					...
					requires : [ "Ext.util.Collection", "Ext.data.Operation",
							"Ext.data.proxy.Memory", "Ext.data.Model",
							"Ext.data.StoreManager", "Ext.util.Grouper" ],
					statics : {
						create : function(a) {
							if (!a.isStore) {
								if (!a.type) {
					...
					applyModel : function(b) {
						if (typeof b == "string") {
							...
							if (!d) {
								Ext.Logger.error('Model with name "' + b
										+ '" does not exist.')
							}
							b = d
						}
						if (b && !b.prototype.isModel && Ext.isObject(b)) {
							b = Ext.data.ModelManager.registerType(b.storeId
									|| b.id || Ext.id(), b)
						}
						if (!b) {
					...
					addData : function(d) {
						var a = this.getProxy().getReader(), c = a.read(d), b = c
								.getRecords();
						this.add(b)
					},
					...
					updateSorters : function(d) {
						var b = this.getGrouper(), c = this.data, a = c
								.getAutoSort();
						c.setAutoSort(false);
						c.setSorters(d);
						if (b) {
					...
					remove : function(b) {
						...
						var m = this, n = false, e = 0, a = this.getAutoSync(), q = m
								.getSyncRemovedRecords(), c = this
								.getDestroyRemovedRecords(), l = b.length, p = [], h = [], o, k = m.data.items, f, g, d;
						for (; e < l; e++) {
							f = b[e];
					...
					doRemoveAll : function(d) {
						var g = this, a = this.getDestroyRemovedRecords(), h = this
								.getSyncRemovedRecords(), c = g.data.all
								.slice(), f = c.length, e, b;
						for (e = 0; e < f; e++) {
							b = c[e];
							b.unjoin(g);
					...
					afterEdit : function(c, g, d) {
						var f = this, h = f.data, a = d[c.getIdProperty()]
								|| c.getId(), b = h.keys.indexOf(a), e;
						...
						if (b === -1 && e !== -1) {
							...
							if (b !== -1 && e === -1) {
								...
								if (e !== -1) {
									f.fireEvent("updaterecord", f, c, e, b, g,
											d)
								}
							}
						}
					...
					sort : function(f, d, c) {
						var e = this.data, b = this.getGrouper(), a = e
								.getAutoSort();
						if (f) {
							e.setAutoSort(false);
							if (typeof c === "string") {
						...
						if (!this.getRemoteSort()) {
							...
							this.fireEvent("sort", this, this.data, this.data
									.getSorters());
							if (e.length) {
					...
					getGroups : function(c) {
						var e = this.data.items, b = e.length, a = this
								.getGrouper(), d = [], k = {}, g, h, j, f;
						for (f = 0; f < b; f++) {
							g = e[f];
					...
					onProxyLoad : function(b) {
						...
						if (e) {
							this.fireAction("datarefresh",
									[ this, this.data, b ], "doDataRefresh")
						}
						d.loaded = true;
						d.loading = false;
						d.fireEvent("load", this, a, e, b);
						Ext.callback(b.getCallback(), b.getScope() || d, [ a,
								b, e ])
					},
					doDataRefresh : function(m, h, d) {
						var c = d.getRecords(), l = this, f = l
								.getDestroyRemovedRecords(), e = h.all.slice(), k = e.length, b = c.length, a = {}, g, j;
					...
					onProxyWrite : function(b) {
						...
						Ext.callback(b.getCallback(), b.getScope() || c, [ a,
								b, d ])
					},
					...
					loadPage : function(f, c, d) {
						...
						var e = this, b = e.getPageSize(), a = e
								.getClearOnPageLoad();
						c = Ext.apply({}, c);
						e.currentPage = f;
...
Ext.define("Ext.data.reader.Array", {
	...
	createFieldAccessExpression : function(g, c, b) {
		var f = this, e = g.getMapping(), d = (e == null) ? f.getModel()
				.getFields().indexOf(g) : e, a;
		if (typeof d === "function") {
...
Ext
		.define(
				"Ext.data.JsonP",
				{
					...
					request : function(m) {
						m = Ext.apply({}, m);
						var i = this, d = Ext.isDefined(m.disableCaching) ? m.disableCaching
								: i.disableCaching, g = m.disableCachingParam
								|| i.disableCachingParam, c = ++i.requestCount, k = m.callbackName
								|| "callback" + c, h = m.callbackKey
								|| i.callbackKey, l = Ext.isDefined(m.timeout) ? m.timeout
								: i.timeout, e = Ext.apply({}, m.params), b = m.url, a = Ext.isSandboxed ? Ext
						...
						if (l > 0) {
							f.timeout = setTimeout(Ext.bind(i.handleTimeout, i,
									[ f ]), l)
						}
					...
					setupErrorHandling : function(a) {
						a.script.onerror = Ext.bind(this.handleError, this,
								[ a ])
					},
					...
					createScript : function(c, d, b) {
						...
						a.setAttribute("src", Ext.urlAppend(c, Ext.Object
								.toQueryString(d)));
					...
					statics : {
						decorate : function(d) {
							...
							if (!d.isDecorated) {
								...
								d.enableBubble([ "append", "remove", "move",
										"insert", "beforeappend",
										"beforeremove", "beforemove",
										"beforeinsert", "expand", "collapse",
							...
							return {
								...
								createNode : function(a) {
									if (Ext.isObject(a) && !a.isModel) {
										a = Ext.data.ModelManager.create(a,
												this.modelName)
									}
								...
								updateInfo : function(g) {
									var j = this, f = j.parentNode, b = (!f ? true
											: f.firstChild == j), e = (!f ? true
								...
								copy : function(d, c) {
									var f = this, b = f
											.callOverridden(arguments), a = f.childNodes ? f.childNodes.length
											: 0, e;
									if (c) {
										for (e = 0; e < a; e++) {
											b.appendChild(f.childNodes[e]
													.copy(true))
										}
									}
									return b
...
Ext.define("Ext.data.NodeStore", {
	...
	createDataCollection : function() {
		var a = this.callParent();
		a.handleSort = Ext.Function
				.bind(this.handleTreeSort, this, [ a ], true);
		a.findInsertionIndex = Ext.Function.bind(this.handleTreeInsertionIndex,
				this, [ a, a.findInsertionIndex ], true);
		return a
	},
...
Ext
		.define(
				"Ext.data.TreeStore",
				{
					...
					applyProxy : function() {
						return Ext.data.Store.prototype.applyProxy.apply(this,
								arguments)
					},
					...
					onNodeAppend : function(n, c) {
						var l = this.getProxy(), j = l.getReader(), b = this
								.getModel(), g = c.raw, d = [], a = j
		...
		.define(
				"Ext.data.Validations",
				{
					...
					getMessage : function(a) {
						var b = this["get" + a[0].toUpperCase() + a.slice(1)
								+ "Message"];
						if (b) {
							return b.call(this)
						}
...
Ext
		.define(
				"Ext.data.proxy.WebStorage",
				{
					...
					read : function(h, o, p) {
						var e = [], a = this.getIds(), l = this.getModel(), q = l
								.getIdProperty(), g = h.getParams() || {}, n = h
								.getSorters(), d = h.getFilters(), b = h
								.getStart(), f = h.getLimit(), c = a.length, j, k, m;
						if (g[q] !== undefined) {
							...
							m.addAll(e);
							if (this.getEnablePagingParams() && b !== undefined
									&& f !== undefined) {
					...
					getRecord : function(d) {
						if (this.cache[d] === undefined) {
							var m = this.getRecordKey(d), n = this
									.getStorageObject().getItem(m), g = {}, f = this
									.getModel(), k = f.getFields().items, e = k.length, h, l, c, j, a, b;
							if (!n) {
								return undefined
							}
							a = Ext.decode(n);
					...
					setRecord : function(l, d) {
						if (d) {
							l.setId(d)
						} else {
							d = l.getId()
						}
						var o = this, a = l.getData(), k = {}, g = o.getModel(), m = g
								.getFields().items, f = m.length, j = 0, p, c, h, q, b;
						for (; j < f; j++) {
							p = m[j];
							c = p.getName();
							...
							if (typeof p.getEncode() == "function") {
								k[c] = p.getEncode()(a[c], l)
							} else {
								if (p.getType().type == "date"
										&& Ext.isDate(a[c])) {
									b = p.getDateFormat();
									if (b) {
										k[c] = Ext.Date.format(a[c], b)
									} else {
										k[c] = a[c].getTime()
									}
								} else {
					...
					setIds : function(a) {
						var c = this.getStorageObject(), d = a.join(","), f = this
								.getId();
						c.removeItem(f);
						if (!Ext.isEmpty(d)) {
							try {
...
Ext
		.define(
				"Ext.data.proxy.Rest",
				{
					...
					buildUrl : function(f) {
						var i = this, e = f.getOperation(), c = e.getRecords()
								|| [], h = c[0], g = i.getModel(), k = g
								.getIdProperty(), j = i.getFormat(), a = i
...
Ext
		.define(
				"Ext.data.proxy.Sql",
				{
					...
					updateModel : function(b) {
						if (b && !this.getTable()) {
							var a = b.modelName, d = this
									.getDefaultDateFormat(), c = a.slice(a
									.lastIndexOf(".") + 1);
							b.getFields().each(
									function(e) {
										if (e.getType().type === "date"
												&& !e.getDateFormat()) {
											e.setDateFormat(d)
										}
									});
							this
									.setUniqueIdStrategy(b.getIdentifier().isUnique);
							this.setTable(c);
					...
					create : function(c, g, d) {
						var e = this, b = e.getDatabaseObject(), a = c
								.getRecords(), f = e.getTableExists();
						c.setStarted();
						b.transaction(function(h) {
							if (!f) {
								e.createTable(h)
							}
							e.insertRecords(a, h, function(i, j) {
								if (c.process(c.getAction(), i) === false) {
									e.fireEvent("exception", this, c)
								}
								if (typeof g == "function") {
									g.call(d || this, c)
								}
					...
					read : function(m, f, b) {
						var s = this, r = s.getDatabaseObject(), d = s
								.getModel(), j = d.getIdProperty(), c = s
								.getTableExists(), q = m.getParams() || {}, n = q[j], a = m
								.getSorters(), l = m.getFilters(), g = m
								.getPage(), e = m.getStart(), p = m.getLimit(), h, o, k;
						q = Ext.apply(q, {
							page : g,
							start : e,
							limit : p,
														...
														if (l.length) {
															...
															t
																	.setRecords(m
																			.getRecords());
															t
																	.setCount(h.items.length);
															t
																	.setTotal(h.items.length)
														}
														if (typeof f == "function") {
															f.call(b || s, m)
														}
					...
					update : function(c, g, d) {
						var e = this, b = c.getRecords(), a = e
								.getDatabaseObject(), f = e.getTableExists();
						c.setStarted();
					...
					destroy : function(c, g, d) {
						...
						a.transaction(function(h) {
							...
							e.destroyRecords(h, b, function(i, j) {
								if (c.process(c.getAction(), i) === false) {
									e.fireEvent("exception", e, c)
								}
								if (typeof g == "function") {
					...
					insertRecords : function(b, a, o, q) {
						var m = this, p = m.getTable(), c = m.getColumns(), l = b.length, f = 0, e = [], h = [], n = [], g = m
								.getUniqueIdStrategy(), d, j, k, r;
						...
						Ext.each(b, function(i) {
							var u = i.getId(), t = m.getRecordData(i), s = m
									.getColumnValues(c, t);
							a.executeSql("INSERT INTO " + p + " ("
									+ c.join(", ") + ") VALUES (" + k + ")", s,
									function(w, v) {
										f++;
										h.push({
					...
					selectRecords : function(p, t, c, b) {
						var u = this, s = u.getTable(), f = u.getModel()
								.getIdProperty(), r = "SELECT * FROM " + s, q = [], a = " WHERE ", l = " ORDER BY ", o, g, v, k, e, h, j, n, d, m;
					...
					updateRecords : function(a, b, l, o) {
						var j = this, n = j.getTable(), d = j.getColumns(), h = b.length, m = j
								.getModel().getIdProperty(), f = 0, c = [], k = [], e, g, p;
						p = new Ext.data.ResultSet({
							records : c,
							success : true
						});
						Ext.each(b, function(i) {
							var t = i.getId(), r = j.getRecordData(i), q = j
									.getColumnValues(d, r), s = [];
							for (e = 0, g = d.length; e < g; e++) {
								s.push(d[e] + " = ?")
							}
							a.executeSql("UPDATE " + n + " SET " + s.join(", ")
									+ " WHERE " + m + " = ?", q.concat(t),
									function(v, u) {
										f++;
										c.push({
					...
					destroyRecords : function(b, c, k, m) {
						var h = this, l = h.getTable(), n = h.getModel()
								.getIdProperty(), a = [], j = [], d = [], e, g, o, f;
						...
						b.executeSql("DELETE FROM " + l + " WHERE "
								+ a.join(" OR "), j, function(p, i) {
							for (e = 0, g = c.length; e < g; e++) {
								f = c[e];
								d.push({
									id : f.getId()
					...
					getRecordData : function(b) {
						var f = this, a = b.getFields(), d = b.getIdProperty(), e = f
								.getUniqueIdStrategy(), h = {}, c, g;
						a.each(function(i) {
							if (i.getPersist()) {
								c = i.getName();
								if (c === d && !e) {
					...
					getSchemaString : function() {
						var j = this, b = [], d = j.getModel(), l = d
								.getIdProperty(), f = d.getFields().items, e = j
								.getUniqueIdStrategy(), g = f.length, c, k, h, a;
						for (c = 0; c < g; c++) {
							k = f[c];
							h = k.getType().type;
							a = k.getName();
					...
					getPersistedModelColumns : function(d) {
						var f = d.getFields().items, e = this
								.getUniqueIdStrategy(), j = d.getIdProperty(), b = [], g = f.length, c, h, a;
						for (c = 0; c < g; c++) {
							h = f[c];
							a = h.getName();
							if (a === j && !e) {
					...
					dropTable : function() {
						var c = this, b = c.getTable(), a = c
								.getDatabaseObject();
						a.transaction(function(d) {
							d.executeSql("DROP TABLE " + b)
						});
						c.setTableExists(false)
					},
					getDatabaseObject : function() {
						return openDatabase(this.getDatabase(), "1.0",
								"Sencha Database", 5 * 1024 * 1024)
					}
				});
		...
		.define(
				"Ext.data.reader.Xml",
				{
					...
					createAccessor : function(b) {
						...
						return function(c) {
							return a
									.getNodeValue(Ext.DomQuery.selectNode(b, c))
						}
					},
					...
					createFieldAccessExpression : function(e, d, c) {
						...
						if (typeof b === "function") {
							...
							b = b.split("@");
							if (b.length === 2 && b[0]) {
								a = 'me.getNodeValue(Ext.DomQuery.selectNode("@'
										+ b[1]
								...
								if (b.length === 2) {
									...
									if (b.length === 1) {
										...
										throw "Unsupported query - too many queries for attributes in "
												+ b.join("@")
									}
								}
							}
		...
		.define(
				"Ext.data.writer.Xml",
				{
					...
					writeRecords : function(a, b) {
						var g = this, d = [], c = 0, f = b.length, h = g
								.getDocumentRoot(), e = g.getRecord(), l = b.length !== 1, k, j;
						d.push(g.getHeader() || "");
						if (!h && l) {
		...
		.define(
				"Ext.dataview.component.ListItem",
				{
					...
					updateHeader : function(b, a) {
						if (b) {
							this.element.getFirstChild().insertFirst(b.element)
						} else {
							if (a) {
								a.destroy()
							}
					...
					applyDisclosure : function(a) {
						if (a && !a.isComponent) {
							a = Ext.factory(a, Ext.Component, this
									.getDisclosure())
						}
						return a
					},
					...
					updateRecord : function(d) {
						var f = this, c = f.dataview || this.getDataview(), g = d
								&& c.prepareData(d.getData(true), c.getStore()
										.indexOf(d), d), e = f.getDataMap(), b = this
								.getBody(), h = this.getDisclosure();
						f._record = d;
						if (e) {
							f.doMapData(e, g, b)
						} else {
						...
						if (h && d && c.getOnItemDisclosure()) {
							...
							h[(g.hasOwnProperty(a) && g[a] === false) ? "hide"
									: "show"]()
						}
						f.fireEvent("updatedata", f, g)
					},
		...
		.define(
				"Ext.util.PositionMap",
				{
					...
					populate : function(d, g) {
						var f = this.map = this.map || [], a = this
								.getMinimumHeight(), b, e, c;
						d++;
						f.length = d;
						f[0] = 0;
					...
					update : function() {
						var d = this.adjustments, n = d.indices, l = d.heights, a = this.map, k = n.length, o = this
								.getMinimumHeight(), c = 0, f, e, m, h, g, b;
						if (!d.indices.length) {
							return false
						}
					...
					getTotalHeight : function() {
						return ((this.map.length - 1) * this.getMinimumHeight())
								+ this.offset
					},
					findIndex : function(a) {
						return this.map.length ? this.binarySearch(this.map, a)
								: 0
					},
...
Ext
		.define(
				"Ext.dataview.List",
				{
					...
					xtype : "list",
					mixins : [ "Ext.mixin.Bindable" ],
					requires : [ "Ext.dataview.IndexBar",
							"Ext.dataview.ListItemHeader",
							"Ext.dataview.component.ListItem",
							"Ext.util.TranslatableList", "Ext.util.PositionMap" ],
					config : {
						layout : "fit",
						indexBar : false,
						icon : null,
					...
					constructor : function(a) {
						...
						if (Ext.os.is.Android4 && !Ext.browser.is.ChromeMobile) {
							c.headerTranslateFn = Ext.Function.createThrottled(
									c.headerTranslateFn, 50, c)
						}
					},
					topItemIndex : 0,
					topItemPosition : 0,
					...
					applyItemMap : function(a) {
						return Ext.factory(a, Ext.util.PositionMap, this
								.getItemMap())
					},
					beforeInitialize : function() {
						var b = this, a;
						...
						a = b.container = b.add(new Ext.Container({
							scrollable : {
								scroller : {
									autoRefresh : false,
									direction : "vertical",
						...
						a.getScrollable().getScroller().getTranslatable()
								.setItems(b.listItems);
						b.setScrollable(a.getScrollable());
						b.scrollableBehavior = a.getScrollableBehavior()
					},
					initialize : function() {
						var d = this, a = d.container, b, c;
						d.updatedItems = [];
						d.headerMap = [];
						d.on(d.getTriggerCtEvent(), d.onContainerTrigger, d);
						d.on(d.getTriggerEvent(), d.onItemTrigger, d);
						d.header = Ext.factory({
						...
						d.container.innerElement.insertFirst(d.header.element);
						d.headerTranslate = d.header.getTranslatable();
						d.headerTranslate.translate(0, -10000);
						if (!d.getGrouped()) {
							d.updatePinHeaders(null)
						}
						a.element.on({
						...
						a.innerElement.on({
							...
							doubletap : "onItemDoubleTap",
							swipe : "onItemSwipe",
							delegate : "." + Ext.baseCSSPrefix
									+ "list-item-body",
							scope : d
						});
						for (b = 0, c = d.scrollDockItems.top.length; b < c; b++) {
							a.add(d.scrollDockItems.top[b])
						}
						for (b = 0, c = d.scrollDockItems.bottom.length; b < c; b++) {
							a.add(d.scrollDockItems.bottom[b])
						}
						if (d.getStore()) {
							d.refresh()
						}
					},
					updateInline : function(b) {
						var a = this;
						a.callParent(arguments);
						if (b) {
							a.setOnItemDisclosure(false);
							a.setIndexBar(false);
							a.setGrouped(false)
						}
					},
					applyIndexBar : function(a) {
						return Ext.factory(a, Ext.dataview.IndexBar, this
								.getIndexBar())
					},
					updateIndexBar : function(a) {
						var b = this;
						if (a && b.getScrollable()) {
							b.indexBarElement = b.getScrollableBehavior()
									.getScrollView().getElement().appendChild(
											a.renderElement);
							a.on({
								index : "onIndex",
								scope : b
							});
							b.element.addCls(b.getBaseCls() + "-indexed")
						}
					},
					updateGrouped : function(c) {
						var e = this, b = this.getBaseCls(), a = b + "-grouped", d = b
								+ "-ungrouped";
						if (c) {
							e.addCls(a);
							e.removeCls(d);
							e.updatePinHeaders(e.getPinHeaders())
						} else {
							e.addCls(d);
							e.removeCls(a);
							e.updatePinHeaders(null)
						}
						if (e.isPainted() && e.listItems.length) {
							e.setItemsCount(e.listItems.length)
						}
					},
					...
					updateItemTpl : function(g, f) {
						var e = this.listItems, d = e.length || 0, a = this
								.getStore(), b, c;
						for (b = 0; b < d; b++) {
							c = e[b];
							c.setTpl(g)
					...
					updateScrollerSize : function() {
						var c = this, b = c.getItemMap().getTotalHeight(), a = c.container
					...
					onResize : function() {
						var d = this, a = d.container, c = a.element, b = d
								.getItemMap().getMinimumHeight(), e;
						if (!d.listItems.length) {
							d.bind(a.getScrollable().getScroller()
									.getTranslatable(), "doTranslate",
									"onTranslate")
						}
						d.containerSize = e = c.getHeight();
						d.setItemsCount(Math.ceil(e / b) + 1)
					},
					scrollDockHeightRefresh : function() {
						var a = this.listItems, e = this.scrollDockItems, d = a.length, b, c;
						for (b = 0; b < d; b++) {
							c = a[b];
							if ((c.isFirst && e.top.length)
									|| (c.isLast && e.bottom.length)) {
								this.updatedItems.push(c)
							}
						}
						this.refreshScroller()
					},
					headerTranslateFn : function(b, a, c) {
						var d = this.getStore().getGroupString(b);
						if (this.currentHeader !== d) {
							this.currentHeader = d;
							this.header.setHtml(d)
						}
						c.translate(0, a)
					},
					onTranslate : function(m, l, c) {
						var C = this, q = C.listItems, j = q.length, s = C.topItemIndex, u = C
								.getItemMap(), g = C.getStore(), z = g
								&& g.getCount(), A = C.getListItemInfo(), D = C
								.getGrouped(), r = C.groups, o = C.headerMap, k = C.headerTranslate, n = C
								.getPinHeaders(), p = z - j + 1, a, w, t, h, B, f, e, v, d, b;
						if (C.updatedItems.length) {
							C.updateItemHeights()
						}
						C.topItemPosition = u.findIndex(-l) || 0;
						C.indexOffset = C.topItemIndex = a = Math.max(0, Math
								.min(C.topItemPosition, p));
						if (D && k && r.length && n) {
							f = u.binarySearch(o, -l);
							e = r[f].children[0];
							if (e) {
								v = l + o[f + 1] - C.headerHeight;
								if (l >= 0) {
									d = -10000
								} else {
									if (v < 0) {
						...
						if (s !== a && a <= p) {
							if (s > a) {
								...
								for (t = 0; t < w; t++) {
									...
									q.push(B);
									h = t + a + j - w;
									C.updateListItem(B, h, A)
								}
							}
						}
						if (q.length && D && n) {
							if (C.headerIndices[a]) {
								b = q[0].getHeader().element;
								if (l < u.map[a]) {
					...
					setItemsCount : function(a) {
						var f = this, g = f.listItems, b = f.getItemMap()
								.getMinimumHeight(), c = {
							xtype : f.getDefaultType(),
							itemConfig : f.getItemConfig(),
							tpl : f.getItemTpl(),
							minHeight : b,
							cls : f.getItemCls()
						}, h = f.getListItemInfo(), d, e;
						for (d = 0; d < a; d++) {
							e = g[d];
							if (!e) {
								e = Ext.factory(c);
							...
							e.dataIndex = null;
							if (h.store) {
								f.updateListItem(e, d + f.topItemIndex, h)
							} else {
								e.setRecord(null);
								e.translate(0, -10000);
								e._list_hidden = true
					...
					getListItemInfo : function() {
						...
						return {
							...
							variableHeights : b.getVariableHeights(),
							defaultItemHeight : b.getItemHeight()
						}
					},
					updateListItem : function(c, b, d) {
						var a = d.store.getAt(b);
						if (this.isSelected(a)) {
							c.addCls(d.selectedCls)
						} else {
							c.removeCls(d.selectedCls)
						}
						c.removeCls([ d.headerCls, d.footerCls, d.firstCls,
								d.lastCls ]);
						this.replaceItemContent(c, b, d)
					},
					taskRunner : function() {
						delete this.intervalId;
						if (this.scheduledTasks
								&& this.scheduledTasks.length > 0) {
							var a = this.scheduledTasks.shift();
							this.doUpdateListItem(a.item, a.index, a.info);
							if (this.scheduledTasks.length === 0
									&& this.getVariableHeights()
									&& !this.container.getScrollable()
											.getScroller().getTranslatable().isAnimating) {
								this.refreshScroller()
							} else {
								if (this.scheduledTasks.length > 0) {
									this.intervalId = requestAnimationFrame(Ext.Function
											.bind(this.taskRunner, this))
								}
							}
						}
					},
					scheduledTasks : null,
					replaceItemContent : function(d, b, e) {
						var a = this.container.getScrollable().getScroller()
								.getTranslatable();
						if (Ext.os.is.Android4
								...
								&& a.isAnimating
								&& a.activeEasingY
								&& Math.abs(a.activeEasingY._startVelocity) > 0.75) {
							if (!this.scheduledTasks) {
								this.scheduledTasks = []
							}
							for ( var c = 0; c < this.scheduledTasks.length; c++) {
								if (this.scheduledTasks[c].item === d) {
									Ext.Array.remove(this.scheduledTasks,
											this.scheduledTasks[c]);
									break
								}
							}
							...
							this.doUpdateListItem(d, b, e)
						}
					},
					doUpdateListItem : function(n, h, b) {
						var f = b.store.getAt(h), m = this.headerIndices, l = this.footerIndices, g = n
								.getHeader(), k = this.scrollDockItems, d = this.updatedItems, c = b.itemMap
								.getItemHeight(h), j, e, a;
						if (!f) {
							n.setRecord(null);
							n.translate(0, -10000);
							n._list_hidden = true;
						...
						n._list_hidden = false;
						if (n.isFirst && k.top.length) {
							for (e = 0, j = k.top.length; e < j; e++) {
								a = k.top[e];
								a.addCls(Ext.baseCSSPrefix
										+ "list-scrolldock-hidden");
								n.remove(a, false)
							}
							n.isFirst = false
						}
						if (n.isLast && k.bottom.length) {
							for (e = 0, j = k.bottom.length; e < j; e++) {
								a = k.bottom[e];
								a.addCls(Ext.baseCSSPrefix
										+ "list-scrolldock-hidden");
								n.remove(a, false)
						...
						if (n.getRecord) {
							if (n.dataIndex !== h) {
								n.dataIndex = h;
								this
										.fireEvent("itemindexchange", this, f,
												h, n)
							}
							if (n.getRecord() === f) {
								n.updateRecord(f)
						...
						if (this.isSelected(f)) {
							n.addCls(b.selectedCls)
						} else {
							n.removeCls(b.selectedCls)
						}
						n.removeCls([ b.headerCls, b.footerCls, b.firstCls,
								b.lastCls ]);
						if (b.grouped) {
							if (m[h]) {
								n.addCls(b.headerCls);
								g.setHtml(b.store.getGroupString(f));
								g.show();
								g.element.setVisibility(true);
								if (!b.variableHeights
										&& c === b.defaultItemHeight) {
									Ext.Array.include(d, n)
								}
							} else {
								g.hide();
								if (!b.variableHeights && !l[h]
										&& c !== b.defaultItemHeight) {
									b.itemMap.setItemHeight(h,
											b.defaultItemHeight);
									b.itemMap.update()
								}
							}
							if (l[h]) {
								n.addCls(b.footerCls);
								if (!b.variableHeights
										&& c === b.defaultItemHeight) {
									Ext.Array.include(d, n)
								}
							...
							if (!b.variableHeights && c !== b.defaultItemHeight) {
								b.itemMap.setItemHeight(h, b.defaultItemHeight);
								b.itemMap.update()
							}
						}
						if (h === 0) {
							...
							for (e = 0, j = k.top.length; e < j; e++) {
								a = k.top[e];
								n.insert(0, a);
								a.removeCls(Ext.baseCSSPrefix
										+ "list-scrolldock-hidden")
							}
							if (j && !b.variableHeights) {
								Ext.Array.include(d, n)
							}
						}
						if (h === b.store.getCount() - 1) {
							n.isLast = true;
							n.addCls(b.lastCls);
							if (!b.grouped) {
								n.addCls(b.footerCls)
						...
						n.$height = b.itemMap.getItemHeight(h);
						if (b.variableHeights) {
							d.push(n)
						}
					},
					updateItemHeights : function() {
						...
						var b = this.updatedItems, f = b.length, c = this
								.getItemMap(), e = this.container
								.getScrollable().getScroller(), m = c
								.getMinimumHeight(), k = this.headerIndices, g = this.headerMap, l = e
								.getTranslatable(), a, d, j, h;
						this.pendingHeightUpdate = false;
						for (d = 0; d < f; d++) {
							j = b[d];
							a = j.dataIndex;
							if (a !== null) {
								h = j.element.getFirstChild().getHeight();
								h = Math.max(h, m);
								if (k && !this.headerHeight && k[a]) {
									this.headerHeight = parseInt(
											j.getHeader().element.getHeight(),
											10)
								}
								c.setItemHeight(a, h)
							}
						...
						for (d = 0; d < f; d++) {
							j = b[d];
							a = j.dataIndex;
							j.$height = c.getItemHeight(a)
						}
						if (h != e.givenSize) {
							e.setSize(h);
							e.refreshMaxPosition();
							if (l.isAnimating) {
								l.activeEasingY.setMinMomentumValue(-e
										.getMaxPosition().y)
							}
						}
					...
					doRefresh : function(f) {
						...
						var d = this, b = d.getStore(), e = d.container
								.getScrollable(), a = e && e.getScroller(), c = d
								.isPainted(), g = b.getCount();
						d.getItemMap().populate(g, this.topItemPosition);
						if (d.getGrouped()) {
							d.findGroupHeaderIndices()
						}
						if (d.listItems.length) {
							if (d.getScrollToTopOnRefresh()) {
								d.topItemIndex = 0;
								d.topItemPosition = 0;
								a.position.y = 0
							}
							d.setItemsCount(d.listItems.length);
							if (c) {
								d.refreshScroller(a)
							} else {
								if (!d.pendingRefreshScroller) {
									d.pendingRefreshScroller = true;
									d.on("painted", function() {
										d.pendingRefreshScroller = false;
										d.refreshScroller(a)
									}, this, {
										single : true
									})
					...
					findGroupHeaderIndices : function() {
						var g = this, h = g.getStore(), d = h.getCount(), c = h
								.getGroups(), k = c.length, l = g.headerIndices = {}, j = g.footerIndices = {}, e, b, a, f;
						g.groups = c;
						for (e = 0; e < k; e++) {
							a = c[e].children[0];
							f = h.indexOf(a);
					...
					onStoreUpdate : function(c, b, d, g) {
						var f = this, a = f.container.getScrollable()
								.getScroller(), e;
						...
						if (g !== d) {
							...
							if (d >= f.topItemIndex
									&& d < f.topItemIndex + f.listItems.length) {
								e = f.getItemAt(d);
								if (e) {
									f.doUpdateListItem(e, d, f
											.getListItemInfo());
									if (f.getVariableHeights()
											&& f.getRefreshHeightOnUpdate()) {
										f.updatedItems.push(e);
										f.updateItemHeights();
										f.refreshScroller(a)
									}
								}
					...
					refreshScroller : function(a) {
						if (!a) {
							a = this.container.getScrollable().getScroller()
						}
						a.scrollTo(0, a.position.y + 1);
						a.scrollTo(0, a.position.y - 1)
					},
					onStoreClear : function() {
						if (this.headerTranslate) {
					...
					onIndex : function(p, c) {
						var r = this, s = c.toLowerCase(), b = r.getStore(), q = b
								.getGroups(), f = q.length, h = r.container
								.getScrollable(), o, e, m, g, k;
						if (h) {
							o = h.getScroller()
						} else {
							return
						...
						if (h && g) {
							c = b.indexOf(g.children[0]);
							o.stopAnimation();
							var l = o.getContainerSize().y, j = o.getSize().y, d = j
									- l, n = r.getItemMap().map[c], a = (n > d) ? d
									: n;
							o.scrollTo(0, a);
							if (this.updatedItems.length > 0
									&& (!this.scheduledTasks || this.scheduledTasks.length === 0)) {
								this.refreshScroller()
							}
						}
					},
					...
					handleItemDisclosure : function(f) {
						var d = this, c = Ext.getCmp(Ext.get(f.getTarget()).up(
								".x-list-item").id), b = c.dataIndex, a = d
								.getStore().getAt(b);
						d.fireAction("disclose", [ d, a, c, b, f ],
								"doDisclose")
					},
					...
					parseEvent : function(d) {
						var b = this, c = Ext.fly(d.getTarget()).findParent(
								"." + Ext.baseCSSPrefix + "list-item", 8), a = Ext
								.getCmp(c.id);
					...
					destroy : function() {
						Ext.destroy(this.getIndexBar(), this.indexBarElement,
								this.header, this.scrollDockItems.top,
								this.scrollDockItems.bottom);
						if (this.intervalId) {
							cancelAnimationFrame(this.intervalId);
							delete this.intervalId
						}
		...
		.define(
				"Ext.dataview.NestedList",
				{
					...
					requires : [ "Ext.dataview.List", "Ext.TitleBar",
							"Ext.Button", "Ext.XTemplate",
							"Ext.data.StoreManager", "Ext.data.NodeStore",
							"Ext.data.TreeStore" ],
					config : {
					...
					updateDetailContainer : function(a, b) {
						if (a) {
							a.onBefore("activeitemchange",
									"onBeforeDetailContainerChange", this);
							a.onAfter("activeitemchange",
									"onDetailContainerChange", this)
						}
					},
					...
					onSelectionChange : function() {
						this.fireEvent.apply(this, [].concat("selectionchange",
								this, Array.prototype.slice.call(arguments)))
					},
					onItemDoubleTap : function() {
						this.fireEvent.apply(this, [].concat("itemdoubletap",
								this, Array.prototype.slice.call(arguments)))
					},
					...
					onBackTap : function() {
						var d = this, c = d.getLastNode(), e = d
								.getDetailCard(), a = e
								&& d.getActiveItem() == e, b = d
								.getLastActiveList();
						this.fireAction("back", [ this, c, b, a ], "doBack")
					},
					doBack : function(e, d, c, a) {
						var b = e.getLayout(), f = (b) ? b.getAnimation()
								: null;
						if (a && c) {
							if (f) {
								f.setReverse(true)
					...
					renderTitleText : function(b, c) {
						if (!b.titleTpl) {
							b.titleTpl = Ext.create("Ext.XTemplate", this
									.getTitleTextTpl(b))
						}
						if (b.isRoot()) {
							var a = this.getInitialConfig("title");
							return (c && a === "") ? this
									.getInitialConfig("backText") : a
						}
					...
					goToNode : function(a) {
						...
						var i = this, d = i.getActiveItem(), k = i
								.getDetailCard(), j = k
								&& i.getActiveItem() == k, h = i
								.goToNodeReverseAnimation(a), c = i.firstList, e = i.secondList, f = i
								.getLayout(), b = (f) ? f.getAnimation() : null, g;
						if (a.isLeaf()) {
							throw new Error(
									"goToNode: passed a node which is a leaf.")
						}
					...
					goToLeaf : function(f) {
						if (!f.isLeaf()) {
							throw new Error(
									"goToLeaf: passed a node which is not a leaf.")
						}
						var e = this, c = e.getDetailCard(f), b = e
								.getDetailContainer(), a = b == this, d = e
								.getLayout(), g = (d) ? d.getAnimation()
								: false;
						if (c) {
					...
					syncToolbar : function(g) {
						var e = this, f = e.getDetailCard(), d = e
								.getLastNode(), b = g
								|| (f && (e.getActiveItem() == f)), a = (b) ? d
								: d.parentNode, c = e.getBackButton();
						if (c) {
							c[a ? "show" : "hide"]();
							if (a && e.getUseTitleAsBackText()) {
								c
										.setText(e.renderTitleText(
												d.parentNode, true))
							}
						}
						if (d) {
					...
					goToNodeReverseAnimation : function(c) {
						...
						return (!a.contains(c) && a.isAncestor(c)) ? true
								: false
					},
					getList : function(b) {
		...
		.define(
				"Ext.dataview.element.List",
				{
							...
							d.children
									.push({
										cls : f.disclosureClsShortCache
												+ " "
												+ ((h[c.getDisclosureProperty()] === false) ? f.hiddenDisplayCache
														: "")
									})
						}
						return d
					...
					updateListItem : function(d, k) {
						var h = this, e = h.dataview, j = Ext.fly(k), g = j
								.down(h.labelClsCache, true), c = e
								.prepareData(d.getData(true), e.getStore()
										.indexOf(d), d), b = e
								.getDisclosureProperty(), a = c
								&& c.hasOwnProperty(b), l = c
								&& c.hasOwnProperty("iconSrc"), f, i;
						g.innerHTML = e.getItemTpl().apply(c);
						if (a) {
							f = j.down(h.disclosureClsCache);
							f[c[b] === false ? "addCls" : "removeCls"]
									(h.hiddenDisplayCache)
						}
						if (e.getIcon()) {
		...
		.define(
				"Ext.direct.RemotingProvider",
				{
					...
					requires : [ "Ext.util.MixedCollection",
							"Ext.util.DelayedTask", "Ext.direct.Transaction",
					...
					constructor : function(a) {
						var b = this;
						b.callParent(arguments);
						b.transactions = Ext.create("Ext.util.Collection",
								function(c) {
									return c.getId()
								});
						b.callBuffer = []
					...
					initAPI : function() {
						...
						for (f in g) {
							if (g.hasOwnProperty(f)) {
								...
								b = g[f];
								for (c = 0, e = b.length; c < e; ++c) {
									h = Ext.create("Ext.direct.RemotingMethod",
											b[c]);
					...
					createHandler : function(c, d) {
						...
						if (!d.getFormHandler()) {
							a = function() {
								b.configureRequest(c, d, Array.prototype.slice
										.call(arguments, 0))
							}
						} else {
							a = function(f, g, e) {
					...
					getTransaction : function(a) {
						return a && a.getTid ? Ext.direct.Manager
								.getTransaction(a.getTid()) : null
					},
					configureRequest : function(d, a, f) {
						...
						b = Ext.create("Ext.direct.Transaction", {
							...
							method : a.getName(),
							data : e,
							callback : i && Ext.isFunction(h) ? Ext.Function
									.bind(h, i) : h
						});
		...
		.define(
				"Ext.event.publisher.ComponentDelegation",
				{
					...
					subscribe : function(g, f) {
						...
						var e = g.match(this.optimizedSelectorRegex), a = this
								.getSubscribers(f, true), k = a.type, c = a.selector, d, i, j, b, h;
						if (e !== null) {
							d = e[1];
							i = e[2].indexOf(">") === -1;
							j = e[3];
					...
					notify : function(d, a) {
						...
						if (b) {
							this.dispatcher.doAddListener(this.targetType, d,
									a, "publish", this, {
										args : [ a, b ]
									}, "before")
						}
					...
					dispatch : function(d, b, c, a) {
						this.dispatcher.doDispatchEvent(this.targetType, d, b,
								c, null, a)
					},
				...
				"Ext.event.publisher.ComponentPaint",
				{
					...
					setDispatcher : function(a) {
						...
						a.doAddListener(b, "*", "hiddenchange",
								"onBeforeComponentHiddenChange", this, null,
								"before");
						a.doAddListener(b, "*", "renderedchange",
								"onComponentRenderedChange", this, null,
								"after");
						a.doAddListener(b, "*", "hiddenchange",
								"onComponentHiddenChange", this, null, "after");
						return this.callParent(arguments)
					},
		...
		.define(
				"Ext.event.publisher.ComponentSize",
				{
					...
					subscribe : function(g, f) {
						...
						if (a.$length === 1) {
							i.addListener(b, g, "painted",
									"onComponentPainted", this, null, "before")
						}
					...
					unsubscribe : function(g, f, h) {
						...
						if (--a.$length === 0) {
							...
							i.removeListener(b, g, "painted",
									"onComponentPainted", this, "before")
						}
						return true
					},
					...
					onComponentSizeChange : function(b, c, a) {
						this.dispatcher.doDispatchEvent(this.targetType, c, a,
								[ b ])
					}
				});
Ext
		.define(
				...
				{
					extend : "Ext.event.publisher.Publisher",
					requires : [ "Ext.env.Browser", "Ext.Element",
							"Ext.event.Dom" ],
					targetType : "element",
					idOrClassSelectorRegex : /^([#|\.])([\w\-]+)$/,
					handledEvents : [ "click", "focus", "blur", "paste",
							"input", "mousemove", "mousedown", "mouseup",
							"mouseover", "mouseout", "keyup", "keydown",
							"keypress", "submit", "transitionend",
					...
					getVendorEventName : function(a) {
						if (a === "transitionend") {
							a = Ext.browser
									.getVendorProperyName("transitionEnd")
						} else {
							if (a === "animationstart") {
								a = Ext.browser
										.getVendorProperyName("animationStart")
							} else {
								if (a === "animationend") {
									a = Ext.browser
											.getVendorProperyName("animationEnd")
								}
							}
						}
						return a
					...
					attachListener : function(a) {
						document.addEventListener(a, this.onEvent, !this
								.doesEventBubble(a));
						return this
					},
					removeListener : function(a) {
						document.removeEventListener(a, this.onEvent, !this
								.doesEventBubble(a));
						return this
					},
		...
		.define(
				"Ext.util.sizemonitor.Abstract",
				{
					...
					refreshSize : function() {
						...
						var i = d.dom.getBoundingClientRect(), b = i.width, k = i.height, l = this
								.getContentBounds(), a = l.width, j = l.height, h = this.contentWidth, f = this.contentHeight, c = this.info, e = false, g;
						this.width = b;
						this.height = k;
						this.contentWidth = a;
						...
						if (g > 0) {
							...
							c.flag = g;
							e = true;
							this.getCallback().apply(this.getScope(),
									this.getArgs())
						}
						return e
					},
...
Ext.define("Ext.util.sizemonitor.OverflowChange", {
	...
	bindListeners : function(b) {
		var a = b ? "addEventListener" : "removeEventListener";
		this.expandMonitor[a]("overflowchanged", this.onExpand, true);
		this.shrinkMonitor[a]("overflowchanged", this.onShrink, true)
	},
	onExpand : function(a) {
		if (a.horizontalOverflow && a.verticalOverflow) {
			return
		}
		Ext.TaskQueue.requestRead("refresh", this)
	},
	...
	refreshMonitors : function() {
		var f = this.expandHelper, e = this.shrinkHelper, b = this
				.getContentBounds(), d = b.width, a = b.height, c;
		if (f && !f.isDestroyed) {
			c = f.style;
			c.width = (d + 1) + "px";
			c.height = (a + 1) + "px"
...
Ext.define("Ext.util.SizeMonitor", {
	requires : [ "Ext.util.sizemonitor.Scroll",
			"Ext.util.sizemonitor.OverflowChange" ],
	constructor : function(a) {
		if (Ext.browser.engineVersion.gtEq("535")) {
			return new Ext.util.sizemonitor.OverflowChange(a)
		} else {
			return new Ext.util.sizemonitor.Scroll(a)
		}
	}
});
Ext
		.define(
				"Ext.event.publisher.ElementSize",
				{
					...
					subscribe : function(e) {
						...
						this.dispatcher.addListener("element", e, "painted",
								"forceRefresh", a);
						return true
					},
					unsubscribe : function(g, a, e) {
						...
						delete f[h];
						b = d[h];
						this.dispatcher.removeListener("element", g, "painted",
								"forceRefresh", b);
						b.destroy();
						delete d[h];
						return true
					...
					onElementResize : function(c, a, b) {
						Ext.TaskQueue.requestRead("dispatch", this, [ c,
								"resize", [ a, b ] ])
					}
				});
Ext
		.define(
				"Ext.event.publisher.TouchGesture",
				{
					...
					handledEvents : [ "touchstart", "touchmove", "touchend",
							"touchcancel" ],
					...
					constructor : function(a) {
						this.processEvents = Ext.Function.bind(
					...
					applyBuffering : function(a) {
						if (a.enabled === true) {
							this.bufferTimer = setInterval(this.processEvents,
									a.interval)
						} else {
					...
					onTouchStart : function(k) {
						var l = this.currentTargets, h = this.currentTouches, o = this.currentTouchesCount, a = {}, m = k.changedTouches, n = m.length, f = k.touches, g = f.length, d, c, j, b;
						o += n;
						if (o > g) {
							for (d = 0; d < g; d++) {
								c = f[d];
						...
						for (d = 0; d < n; d++) {
							...
							h[j] = c;
							l[j] = this.getBubblingTargets(this
									.getElementTarget(c.target))
						}
						k.setTargets(l);
						for (d = 0; d < n; d++) {
								...
								.override({
									...
									onEvent : function(d) {
										...
										if (c === "mousedown"
											...
											a.initMouseEvent("mouseup",
													d.bubbles, d.cancelable,
					...
					onEnd : function(g) {
						...
						if (j) {
							...
							if (c <= d) {
								if (h !== b) {
									return this
											.fail(this.self.DIFFERENT_TARGET)
								}
				...
				"Ext.event.recognizer.Drag",
				{
					...
					onTouchMove : function(d) {
						...
						if (!this.isStarted) {
							...
							this.fire("dragstart", d, this.startTouches, this
									.getInfo(d, this.startTouch))
						} else {
		...
		.define(
				"Ext.event.recognizer.Swipe",
				{
					...
					onTouchMove : function(f) {
						var h = f.changedTouches[0], b = h.pageX, g = h.pageY, c = Math
								.abs(b - this.startX), a = Math.abs(g
								- this.startY), d = f.time;
					...
					onTouchEnd : function(i) {
						...
						var h = i.changedTouches[0], l = h.pageX, j = h.pageY, g = l
								- this.startX, f = j - this.startY, c = Math
								.abs(g), b = Math.abs(f), m = this
								.getMinDistance(), d = i.time - this.startTime, k, a;
...
Ext
		.define(
				"Ext.event.recognizer.HorizontalSwipe",
				{
					...
					onTouchMove : function(f) {
						var h = f.changedTouches[0], g = h.pageY, a = Math
								.abs(g - this.startY), d = f.time, c = this
					...
					onTouchEnd : function(f) {
						if (this.onTouchMove(f) !== false) {
							var i = f.changedTouches[0], a = i.pageX, b = a
									- this.startX, h = Math.abs(b), d = f.time
									- this.startTime, g = this.getMinDistance(), c;
							if (h < g) {
								return this.fail(this.self.DISTANCE_NOT_ENOUGH)
							}
							c = (b < 0) ? "left" : "right";
...
Ext.define("Ext.event.recognizer.VerticalSwipe",
		{
			...
			onTouchMove : function(g) {
				var h = g.changedTouches[0], a = h.pageX, b = Math.abs(a
						- this.startX), d = this.getMaxDuration(), c = this
						.getMaxOffset(), f = g.time;
			...
			onTouchEnd : function(d) {
				if (this.onTouchMove(d) !== false) {
					var i = d.changedTouches[0], h = i.pageY, a = h
							- this.startY, g = Math.abs(a), c = d.time
							- this.startTime, f = this.getMinDistance(), b;
					if (g < f) {
						return this.fail(this.self.DISTANCE_NOT_ENOUGH)
					}
					b = (a < 0) ? "up" : "down";
		...
		.define(
				"Ext.field.Checkbox",
				{
					...
					getSameGroupFields : function() {
						var j = this.up("formpanel") || this.up("fieldset"), b = this
								.getName(), g = this.qsaLeftRe, c = this.qsaRightRe, f = [], a, d, e, h;
						if (!j) {
							j = Ext.Viewport
						}
						b = b.replace(g, "\\[");
...
Ext
		.define(
				"Ext.picker.Slot",
				{
					...
					requires : [ "Ext.XTemplate", "Ext.data.Store",
							"Ext.Component", "Ext.data.StoreManager" ],
					isSlot : true,
					config : {
						title : null,
						showTitle : true,
					...
					updateDisplayField : function(a) {
						if (!this.config.itemTpl) {
							this
									.setItemTpl('<div class="'
											+ Ext.baseCSSPrefix
											+ 'picker-item {cls} <tpl if="extra">'
											+ Ext.baseCSSPrefix
											+ 'picker-invalid</tpl>">{' + a
											+ "}</div>")
						}
					},
					...
					setupBar : function() {
						...
						var a = this.element, e = this.innerElement, f = this
								.getPicker(), g = f.bar, k = this.getValue(), b = this
								.getShowTitle(), j = this.getTitle(), h = this
					...
					onScrollEnd : function(b, a, g) {
						var f = this, d = Math.round(g
								/ f.picker.bar.getHeight()), c = f
								.getViewItems(), e = c[d];
						if (e) {
							f.selectedIndex = d;
							f.selectedNode = e;
							f.fireEvent("slotpick", f, f.getValue(),
									f.selectedNode)
						}
					},
					getValue : function(c) {
		...
		.define(
				"Ext.picker.Date",
				{
					...
					createSlots : function() {
						var k = this, c = k.getSlotOrder(), m = k.getYearFrom(), e = k
								.getYearTo(), f = [], l = [], b = [], h = m > e, j, d, a;
						while (m) {
							f.push({
								text : m,
								value : m
					...
					onSlotPick : function() {
						var g = this.getValue(true), f = this.getDaySlot(), e = g
								.getFullYear(), d = g.getMonth(), j = [], a, b;
						if (!g || !Ext.isDate(g) || !f) {
							return
						}
						this.callParent();
						...
						var h = f.getStore(), m = f.getViewItems(), l = f
								.getValueField(), c, k;
...
Ext.define("Ext.field.DatePicker", {
	...
	updateValue : function(d, b) {
		...
		if (d !== null) {
			c.getComponent().setValue(
					Ext.Date.format(d, c.getDateFormat()
							|| Ext.util.Format.defaultDateFormat))
		} else {
			c.getComponent().setValue("")
		}
	...
	updateDateFormat : function(c, a) {
		...
		if (c != a && Ext.isDate(b)) {
			this.getComponent().setValue(
					Ext.Date.format(b, c || Ext.util.Format.defaultDateFormat))
		}
	},
	getValue : function() {
	...
	getFormattedValue : function(b) {
		var a = this.getValue();
		return (Ext.isDate(a)) ? Ext.Date.format(a, b || this.getDateFormat()
...
Ext
		.define(
				"Ext.field.Select",
				{
					...
					requires : [ "Ext.Panel", "Ext.picker.Picker",
							"Ext.data.Store", "Ext.data.StoreManager",
							"Ext.dataview.List" ],
					config : {
						ui : "select",
						valueField : "value",
						...
						clearIcon : false,
						usePicker : (Ext.os.is.BlackBerry && Ext.os.version
								.getMajor() === 10) ? false : "auto",
						autoSelect : true,
					...
					applyValue : function(d) {
						...
						if ((d != undefined && !d.isModel) && b) {
							c = b.find(this.getValueField(), d, null, null,
									null, true);
							if (c == -1) {
								c = b.find(this.getDisplayField(), d, null,
										null, null, true)
							}
							a = b.getAt(c)
						}
					...
					updateValue : function(b, a) {
						this.record = b;
						this.callParent([ (b && b.isModel) ? b.get(this
								.getDisplayField()) : "" ])
					},
					getValue : function() {
						var a = this.record;
						return (a && a.isModel) ? a.get(this.getValueField())
								: null
					},
					getRecord : function() {
						return this.record
					...
					getPhonePicker : function() {
						...
						if (!this.picker) {
							this.picker = Ext.create("Ext.picker.Picker", Ext
									.apply({
										slots : [ {
											align : "center",
											name : this.getName(),
													...
													.apply(
															{
																...
																layout : "fit",
																hideOnMaskTap : true,
																width : Ext.os.is.Phone ? "14em"
																		: "18em",
																height : (Ext.os.is.BlackBerry && Ext.os.version
																		.getMajor() === 10) ? "12em"
																		: (Ext.os.is.Phone ? "12.5em"
																				: "22em"),
																items : {
																	xtype : "list",
																	store : this
					...
					showPicker : function() {
						...
						if (this.getUsePicker()) {
							...
							var f = this.getTabletPicker(), g = f.down("list"), c, a;
							b = g.getStore();
							...
							f.showBy(this.getComponent(),
									(Ext.os.is.BlackBerry && Ext.os.version
											.getMajor() === 10) ? "t-b" : null);
					...
					onPickerChange : function(d, f) {
						var e = this, g = f[e.getName()], b = e.getStore(), c = b
								.find(e.getValueField(), g, null, null, null,
										true), a = b.getAt(c);
						e.setValue(a)
					},
					onChange : function(f, h, e) {
						var g = this, b = g.getStore(), d = (b) ? b.find(g
								.getDisplayField(), e) : -1, c = g
								.getValueField(), a = (b) ? b.getAt(d) : null;
						e = (a) ? a.get(c) : null;
					...
					doSetDisabled : function(a) {
						Ext.Component.prototype.doSetDisabled.apply(this,
								arguments)
					},
					setDisabled : function() {
						Ext.Component.prototype.setDisabled.apply(this,
								arguments)
					},
					reset : function() {
						var b = this.getStore(), a = (this.originalValue) ? this.originalValue
								: b.getAt(0);
						if (b && a) {
							this.setValue(a)
						}
		...
		.define(
				"Ext.slider.Slider",
				{
					...
					factoryThumb : function() {
						return Ext.factory(this.getThumbConfig(),
								Ext.slider.Thumb)
					},
					getThumbs : function() {
						return this.innerItems
					...
					setIndexValue : function(d, g, f) {
						var c = this.getThumb(d), b = this.getValue(), e = this.offsetValueRatio, a = c
								.getDraggable();
						a.setOffset((g - this.getMinValue()) * e, null, f);
						b[d] = g
					},
					...
					refreshThumbConstraints : function(d) {
						var b = this.getAllowThumbsOverlapping(), a = d
								.getDraggable().getOffset().x, c = this
								.getThumbs(), e = this.getThumbIndex(d), g = c[e - 1], h = c[e + 1], f = this.thumbWidth;
						if (g) {
					...
					onTap : function(j) {
						...
						var n = j.touch.point.x, h = this.element, c = h.getX(), d = n
								- c - (this.thumbWidth / 2), o = this
								.constrainValue(this.getMinValue() + d
										/ this.offsetValueRatio), r = this
								.getValue(), q = Infinity, m = r.length, g, f, l, p, b, a;
						if (m === 1) {
							p = 0
						} else {
							for (g = 0; g < m; g++) {
					...
					applyValue : function(g) {
						var d = Ext.Array.from(g || 0), b = [], c = this
								.getMinValue(), a, e, f;
						for (e = 0, f = d.length; e < f; e++) {
					...
					updateValue : function(f, b) {
						var a = this.getThumbs(), d = f.length, e = this
								.getMinValue(), g = this.offsetValueRatio, c;
						this.setThumbsCount(d);
						for (c = 0; c < d; c++) {
							a[c].getDraggable().setExtraConstraint(null)
									.setOffset((f[c] - e) * g)
						}
						for (c = 0; c < d; c++) {
...
Ext
		.define(
				"Ext.field.Slider",
				{
					...
					reset : function() {
						var b = this.config, a = (this.config
								.hasOwnProperty("values")) ? b.values : b.value;
						this.setValue(a)
					},
					doSetDisabled : function(a) {
						this.callParent(arguments);
...
Ext.define("Ext.util.TapRepeater", {
	...
	tap : function(b) {
		var a = this;
		a.fireEvent("tap", a, b);
		a.setTimer(Ext.defer(a.tap, a.getAccelerate() ? a.easeOutExpo(Ext.Date
				.getElapsed(a.tapStartTime), 400, -390, 12000) : a
				.getInterval(), a, [ b ]))
	},
...
Ext.define("Ext.field.Spinner", {
	...
	updateComponent : function(c) {
		...
		if (c) {
			...
			this.downRepeater = this.createRepeater(this.spinDownButton,
					this.onSpinDown);
	...
	spin : function(h) {
		var c = this, b = c.getValue(), a = c.getStepValue(), g = h ? "down"
		...
		.define(
				"Ext.form.Panel",
				{
					...
					submit : function(a) {
						...
						d = c.getValues(c.getStandardSubmit()
								|| !a.submitDisabled);
						return c.fireAction("beforesubmit", [ c, d, a ],
								"doBeforeSubmit")
					},
					...
					getNextField : function() {
						var a = this.getFieldsArray(), c = this
								.getFocusedField(), b;
						if (c) {
							b = a.indexOf(c);
							if (b !== a.length - 1) {
		...
		.define(
				"Ext.fx.runner.Css",
				{
					...
					constructor : function() {
						...
						if (a) {
							this.transformMethods = [ "translateX",
									"translateY", "translateZ", "rotate",
									"rotateX", "rotateY", "rotateZ", "skewX",
									"skewY", "scaleX", "scaleY", "scaleZ" ]
						} else {
							this.transformMethods = [ "translateX",
									"translateY", "rotate", "skewX", "skewY",
									"scaleX", "scaleY" ]
						}
		...
		.define(
				"Ext.fx.runner.CssTransition",
				{
					...
					attachListeners : function() {
						...
						this.getEventDispatcher().addListener("element", "*",
								"transitionend", "onTransitionEnd", this)
					},
						...
						if (p) {
							...
							for (l = 0; l < f; l++) {
								...
								if (c.length == 0) {
									...
									f--;
									n = true;
									this.onAnimationEnd(d, c.data, c.animation,
											t)
								}
							}
						}
					...
					getTestElement : function() {
						...
						if (!c) {
							...
							this.testElementComputedStyle = window
									.getComputedStyle(c)
						}
						return c
					},
					...
					run : function(p) {
						...
						for (A = 0, o = p.length; A < o; A++) {
							...
							b = a.sessions;
							if (b.length > 0) {
								this.refreshRunningAnimationsData(d, Ext.Array
										.merge(I, v), true, G.replacePrevious)
							}
							c = a.nameMap;
							D = a.nameList;
							t = {};
...
Ext
		.define(
				"Ext.fx.animation.Cube",
				{
					...
					getData : function() {
						var m = this.getTo(), n = this.getFrom(), k = this
								.getBefore(), a = this.getAfter(), e = this
								.getOut(), j = this.getDirection(), b = this
								.getElement(), g = b.getWidth(), c = b
								.getHeight(), l = e ? "100% 100%" : "0% 0%", i = 1, d = 1, f = {
							rotateY : 0,
							translateZ : 0
						}, h = {
							rotateY : 0,
...
Ext
		.define(
				"Ext.fx.animation.Wipe",
				{
					...
					refresh : function() {
						var h = this, a = h.getElement(), g = a.dom
								.getBoundingClientRect(), n = g.width, f = g.height, l = h
								.getFrom(), m = h.getTo(), d = h.getOut(), j = h
								.getDirection(), c = 0, b = 0, k = 0, i = 0, o, e;
						switch (j) {
						case "up":
							if (d) {
...
Ext.define("Ext.fx.easing.EaseIn",
		{
			...
			getValue : function() {
				var c = Ext.Date.now() - this.getStartTime(), g = this
						.getDuration(), b = this.getStartValue(), a = this
						.getEndValue(), h = this.distance, e = c / g, d = Math
						.pow(e, this.getExponent()), f = b + (d * h);
				if (c >= g) {
					this.isEnded = true;
					return a
				}
...
Ext.define("Ext.fx.layout.card.ScrollCover", {
	...
	onActiveItemChange : function(c, g, d, k, e) {
		...
		if (g && d) {
			...
			g.renderElement.dom.style.setProperty("visibility", "hidden",
					"!important");
			...
			b.getWrapper().dom.style
					.setProperty("z-index", "100", "!important");
			g.show();
			b.on({
	...
	onInAnimationEnd : function() {
		this.inItem.getTranslatable().getWrapper().dom.style
...
Ext.define("Ext.fx.layout.card.ScrollReveal", {
	...
	onOutAnimationEnd : function() {
		this.outItem.getTranslatable().getWrapper().dom.style
				.removeProperty("z-index");
		this.lastController.resume()
	}
});
		...
		.define(
				"Ext.fx.runner.CssAnimation",
				{
					...
					attachListeners : function() {
						...
						this.listenersAttached = true;
						a.addListener("element", "*", "animationstart",
								"onAnimationStart", this);
						a.addListener("element", "*", "animationend",
								"onAnimationEnd", this)
					},
					...
					addKeyframesRule : function(a, c) {
						...
						i = g.cssRules;
						d = i.length;
						g.insertRule("@" + this.vendorPrefix + "keyframes " + a
								+ "{}", d);
						b = i[d];
						for (k in c) {
							e = c[k];
				...
				"Ext.navigation.Bar",
				{
					...
					doChangeView : function(k, c, g) {
						var r = this, o = r.leftBox, e = o.element, f = r.titleComponent, m = f.element, n = r
								...
								&& k.getLayout().getAnimation(), p = q
								&& q.isAnimation && k.isPainted(), d, i, a, j, b;
						if (p) {
							r.isAnimating = true;
					...
					measureView : function(e, u, k) {
						var w = this, j = w.element, v = w.leftBox.element, p = w.titleComponent.element, l = Math
								.min(j.getWidth() / 3, 200), q = v.getWidth(), c = j
								.getX(), m = j.getWidth(), n = p.getX(), d = p
								.getLeft(), s = p.getWidth(), r = e.x, t = e.width, a = e.left, h = Ext.os.is.Android2
...
Ext.define("Ext.navigation.View", {
	...
	beforePop : function(f) {
		...
		if (Ext.isString(f) || Ext.isObject(f)) {
			var d = g.length - 1, a;
			for (a = d; a >= 0; a--) {
				if ((Ext.isString(f) && Ext.ComponentQuery.is(g[a], f))
						|| (Ext.isObject(f) && f == g[a])) {
					f = d - a;
					break
				}
			}
...
Ext
		.define(
				"Ext.plugin.ListPaging",
				{
					...
					init : function(c) {
						var a = c.getScrollable().getScroller(), b = c
								.getStore();
						this.setList(c);
						this.setScroller(a);
						...
						c.updateStore = Ext.Function.createInterceptor(
								c.updateStore, this.bindStore, this);
					...
					applyLoadTpl : function(a) {
						return (Ext.isObject(a) && a.isTemplate) ? a
								: new Ext.XTemplate(a)
					},
					applyLoadMoreCmp : function(a) {
						...
						return Ext.factory(a, Ext.Component, this
								.getLoadMoreCmp())
					},
					...
					onStoreLoad : function(a) {
						var d = this.getLoadMoreCmp(), b = this.getLoadTpl(), c = this
					...
					storeFullyLoaded : function() {
						var a = this.getList().getStore(), b = a
								.getTotalCount();
		...
		.define(
				"Ext.plugin.PullRefresh",
				{
					...
					initScrollable : function() {
						var d = this, g = d.getList(), b = g.getStore(), f = d
								.getPullTpl(), c = d.element, e = g
								.getScrollable(), a;
						if (!e) {
							return
						}
						...
						g.container.insert(0, d);
						if (b) {
							if (b.isAutoLoading()) {
								g.setLoadingText(null)
							} else {
								b.on({
									load : {
										single : true,
					...
					updateList : function(a, c) {
						...
						if (a && a != c) {
							a.on({
								order : "after",
								scrollablechange : b.onScrollableChange,
								scope : b
							})
						} else {
							if (c) {
					...
					onLatestFetched : function(d) {
						var j = this.getList().getStore(), b = j.getData(), c = d
								.getRecords(), a = c.length, g = [], h, f, e;
						for (e = 0; e < a; e++) {
							h = c[e];
					...
					onBounceTop : function(e) {
						var b = this, d = b.pullHeight, c = b.getList(), a = c
								.getScrollable().getScroller();
						if (!b.isReleased) {
							if (!d) {
								b.onPainted();
						...
						b.getTranslatable().translate(0, -e)
					},
					onScrollerDragEnd : function() {
						var b = this;
						if (b.isRefreshing) {
							var c = b.getList(), a = c.getScrollable()
									.getScroller();
					...
					loadStore : function() {
						var b = this, c = b.getList(), a = c.getScrollable()
								.getScroller();
					...
					resetRefreshState : function() {
						...
						a.setViewState("pull");
						a.updatedEl.setHtml(this.getLastUpdatedText()
								+ "&nbsp;"
								+ Ext.util.Format.date(a.lastUpdated,
										"m/d/Y h:iA"))
					}
				});
		...
		.define(
				"Ext.tab.Panel",
				{
					...
					doSetActiveItem : function(d, j) {
						if (d) {
							var f = this.getInnerItems(), g = f.indexOf(j), i = f
									.indexOf(d), e = g > i, c = this
									.getLayout().getAnimation(), b = this
									.getTabBar(), h = b.parseActiveTab(g), a = b
									.parseActiveTab(i);
							if (c && c.setReverse) {
								c.setReverse(e)
							}
					...
					onItemAdd : function(e) {
						...
						var c = k.getTabBar(), o = e.getInitialConfig(), d = o.tab
								|| {}, g = (e.getTitle) ? e.getTitle()
								: o.title, i = (e.getIconCls) ? e.getIconCls()
								: o.iconCls, j = (e.getHidden) ? e.getHidden()
								: o.hidden, n = (e.getDisabled) ? e
								.getDisabled() : o.disabled, p = (e.getBadgeText) ? e
								.getBadgeText()
								: o.badgeText, b = k.getInnerItems(), h = b
								.indexOf(e), l = c.getItems(), a = c
								.getActiveTab(), m = (l.length >= b.length)
								&& l.getAt(h), f;
						if (g && !d.title) {
							d.title = g
						}
		...
		.define(
				"Ext.viewport.Default",
				{
					...
					constructor : function(a) {
						...
						this.callParent([ a ]);
						if (!Ext.os.is.Android
								|| Ext.browser.name == "ChromeMobile") {
							if (this.supportsOrientation()) {
								this.addWindowListener("orientationchange", b(
										this.onOrientationChange, this))
							} else {
								this.addWindowListener("resize", b(
										this.onResize, this))
							}
						}
						document.addEventListener("focus", b(
								this.onElementFocus, this), true);
						document.addEventListener("blur", b(this.onElementBlur,
								this), true);
						Ext.onDocumentReady(this.onDomReady, this);
						this.on("ready", this.onReady, this, {
							single : true
						});
						this.getEventDispatcher().addListener("component", "*",
								"fullscreen", "onItemFullscreenChange", this);
						return this
					},
					onDomReady : function() {
						this.isReady = true;
					...
					render : function() {
						if (!this.rendered) {
							var a = Ext.getBody(), b = Ext.baseCSSPrefix, h = [], d = Ext.os, g = d.name
									.toLowerCase(), f = Ext.browser.name
									.toLowerCase(), e = d.version.getMajor(), c = this
									.getOrientation();
							this.renderTo(a);
					...
					applyAutoBlurInput : function(a) {
						var b = (Ext.feature.has.Touch) ? "touchstart"
								: "mousedown";
						if (a) {
							this.addWindowListener(b, this.doBlurInput, false)
						} else {
							this.removeWindowListener(b, this.doBlurInput,
									false)
						}
						return a
					},
					applyAutoMaximize : function(a) {
						...
						if (a) {
							...
							this.on("orientationchange",
									"doAutoMaximizeOnOrientationChange", this)
						} else {
							this.un("ready", "doAutoMaximizeOnReady", this);
							this.un("orientationchange",
									"doAutoMaximizeOnOrientationChange", this)
						}
						return a
					},
					applyPreventPanning : function(a) {
						if (a) {
							this.addWindowListener("touchmove",
									this.doPreventPanning, false)
						} else {
							this.removeWindowListener("touchmove",
									this.doPreventPanning, false)
						}
						return a
					},
					applyPreventZooming : function(a) {
						var b = (Ext.feature.has.Touch) ? "touchstart"
								: "mousedown";
						if (a) {
							this.addWindowListener(b, this.doPreventZooming,
									false)
						} else {
							this.removeWindowListener(b, this.doPreventZooming,
									false)
						}
						return a
					},
					...
					onOrientationChange : function() {
						var b = this.getOrientation(), a = this
								.determineOrientation();
						if (a !== b) {
					...
					fireOrientationChangeEvent : function(b, c) {
						...
						this.orientation = b;
						this.updateSize();
						this.fireEvent("orientationchange", this, b,
								this.windowWidth, this.windowHeight)
					},
					updateSize : function(b, a) {
						this.windowWidth = b !== undefined ? b : this
								.getWindowWidth();
						this.windowHeight = a !== undefined ? a : this
								.getWindowHeight();
						return this
					},
...
Ext
		.define(
				"Ext.viewport.Android",
				{
					...
					constructor : function() {
						this.on("orientationchange",
								"doFireOrientationChangeEvent", this, {
									prepend : true
								});
						this.on("orientationchange", "hideKeyboardIfNeeded",
								this, {
									prepend : true
								});
						this.callParent(arguments);
					...
					getDummyInput : function() {
						var a = this.dummyInput, c = this.focusedElement, b = Ext
								.fly(c).getPageBox();
						if (!a) {
							this.dummyInput = a = document
									.createElement("input");
					...
					applyAutoMaximize : function(a) {
						...
						if (!a) {
							...
							this.onAfter("orientationchange", "doFixSize",
									this, {
										buffer : 100
									})
						} else {
							...
							this
									.unAfter("orientationchange", "doFixSize",
											this)
						}
					},
					fixSize : function() {
					...
					determineOrientation : function() {
						return (this.getWindowHeight() >= this.getWindowWidth()) ? this.PORTRAIT
								: this.LANDSCAPE
					},
					getActualWindowOuterHeight : function() {
						return Math.round(this.getWindowOuterHeight()
					...
					maximize : function() {
						...
						this.setHeight(a);
						var d = Ext.Function.bind(this.isHeightMaximized, this,
								[ a ]);
						this.scrollToTop();
						this.waitUntil(d, this.fireMaximizeEvent,
								this.fireMaximizeEvent)
					},
								...
								.override({
									...
									onWindowResize : function() {
										...
										if (this.getAutoMaximize()
												...
												&& d < g
												&& ((d >= g
														- this.addressBarHeight) || !this.focusedElement)) {
											this.scrollToTop()
										}
									},
									fixSize : function() {
										...
										if (d === "landscape" && (f < g)
												|| d === "portrait" && (f >= g)) {
											e = this
													.getActualWindowOuterHeight()
										} else {
											e = this.getWindowHeight()
										}
										this.waitUntil(function() {
											return e > this.getWindowHeight()
										}, this.doFixSize, this.doFixSize, 50,
												1000)
									}
								})
					} else {
...
Ext.define("Ext.viewport.Ios", {
	...
	getScreenHeight : function() {
		return window.screen[this.orientation === this.PORTRAIT ? "height"
				: "width"]
	},
