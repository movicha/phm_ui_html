// The NFC Plugin class defining the functionality for interaction between NFC enabled devices and various types of NFC cards.
// The Phm Health application uses Mifare Classic 1K card which are ndef formatted.
